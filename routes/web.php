...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'access-laporan'], function () {
        ...
        Route::get('/report/polda/daily/{uuid}/{tglStart}/{tglEnd}/html', 'ReportController@reportPoldaPerdayHTML')->name('report_polda_perday_html');
    ...
    Route::group(['prefix' => 'data'], function () {
        Route::get('/operation-plan/all', 'RencanaOperasiController@getAllOperation')->name('get_all_operation');
        ...
        Route::get('/queue-check/{bacthId}', 'HelperController@queueCheck')->name('queue_check');
    });
});