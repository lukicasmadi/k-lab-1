...
class HomeController extends Controller
{
    ...
    public function viewInputFromChart($indexData)
    {
        if(empty(operationPlans())) {
            ...
            excelViewAbsensi($polda, indonesiaDate($whereDate), $whereDate, null);
            ...
            excelViewAbsensi($polda, indonesiaDate($whereDate), $whereDate, $cd->rencanaOperasi->name, yearOnly($cd->rencanaOperasi->start_date));
        }
    }
