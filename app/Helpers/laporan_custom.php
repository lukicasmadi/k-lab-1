...
if (! function_exists('prevAnev')) {
    function prevAnev($rencana_operasi_id, $start_date, $end_date, $year) {
        $outputLaporanPrevAnev = DailyInputPrev::selectRaw('
        ...
        return $outputLaporanPrevAnev;
    }
}

if (! function_exists('currentAnev')) {
    function currentAnev($rencana_operasi_id, $start_date, $end_date, $year) {
        $outputLaporanCurrentAnev = DailyInput::selectRaw('
        ...
        return $outputLaporanCurrentAnev;
    }
}