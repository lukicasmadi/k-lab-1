...
if (! function_exists('compareAllPoldaInput')) {
    function compareAllPoldaInput($data_prev, $data_current, $start_date, $end_date, $prev_year, $current_year) {
        ...
        foreach($data_prev as $prev) {
            ...
            $sheet->setCellValue($flag[0].'66', applyZero($prev->prev_kendaraan_yang_terlibat_pelanggaran_sepeda_motor_p_sum));
            $sheet->setCellValue($flag[0].'67', applyZero($prev->prev_kendaraan_yang_terlibat_pelanggaran_mobil_penumpang_p_sum));
            $sheet->setCellValue($flag[0].'68', applyZero($prev->prev_kendaraan_yang_terlibat_pelanggaran_mobil_bus_p_sum));
            $sheet->setCellValue($flag[0].'69', applyZero($prev->prev_kendaraan_yang_terlibat_pelanggaran_mobil_barang_p_sum));
            $sheet->setCellValue($flag[0].'69', applyZero($prev->prev_kendaraan_yang_terlibat_pelanggaran_kendaraan_khusus_p_sum));
            $sheet->setCellValue($flag[0].'73', applyZero($prev->prev_profesi_pelaku_pelanggaran_pns_p_sum));
            $sheet->setCellValue($flag[0].'74', applyZero($prev->prev_profesi_pelaku_pelanggaran_karyawan_swasta_p_sum));
            $sheet->setCellValue($flag[0].'75', applyZero($prev->prev_profesi_pelaku_pelanggaran_pelajar_mahasiswa_p_sum));
            $sheet->setCellValue($flag[0].'76', applyZero($prev->prev_profesi_pelaku_pelanggaran_pengemudi_supir_p_sum));
            $sheet->setCellValue($flag[0].'77', applyZero($prev->prev_profesi_pelaku_pelanggaran_tni_p_sum));
            $sheet->setCellValue($flag[0].'78', applyZero($prev->prev_profesi_pelaku_pelanggaran_polri_p_sum));
            $sheet->setCellValue($flag[0].'79', applyZero($prev->prev_profesi_pelaku_pelanggaran_lain_lain_p_sum));
            $sheet->setCellValue($flag[0].'82', applyZero($prev->prev_usia_pelaku_pelanggaran_kurang_dari_15_tahun_p_sum));
            $sheet->setCellValue($flag[0].'83', applyZero($prev->prev_usia_pelaku_pelanggaran_16_20_tahun_p_sum));
            $sheet->setCellValue($flag[0].'84', applyZero($prev->prev_usia_pelaku_pelanggaran_21_25_tahun_p_sum));
            $sheet->setCellValue($flag[0].'85', applyZero($prev->prev_usia_pelaku_pelanggaran_26_30_tahun_p_sum));
            $sheet->setCellValue($flag[0].'86', applyZero($prev->prev_usia_pelaku_pelanggaran_31_35_tahun_p_sum));
            $sheet->setCellValue($flag[0].'87', applyZero($prev->prev_usia_pelaku_pelanggaran_36_40_tahun_p_sum));
            $sheet->setCellValue($flag[0].'88', applyZero($prev->prev_uusia_pelaku_pelanggaran_41_45_tahun_p_sum));
            $sheet->setCellValue($flag[0].'89', applyZero($prev->prev_usia_pelaku_pelanggaran_46_50_tahunn_p_sum));
            $sheet->setCellValue($flag[0].'90', applyZero($prev->prev_usia_pelaku_pelanggaran_51_55_tahunn_p_sum));
            $sheet->setCellValue($flag[0].'91', applyZero($prev->prev_usia_pelaku_pelanggaran_56_60_tahun_p_sum));
            $sheet->setCellValue($flag[0].'92', applyZero($prev->prev_usia_pelaku_pelanggaran_diatas_60_tahun_p_sum));
            $sheet->setCellValue($flag[0].'95', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_a_p_sum));
            $sheet->setCellValue($flag[0].'96', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_a_umum_p_sum));
            $sheet->setCellValue($flag[0].'97', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_b1_p_sum));
            $sheet->setCellValue($flag[0].'98', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_b1_umum_p_sum));
            $sheet->setCellValue($flag[0].'99', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_b2_p_sum));
            $sheet->setCellValue($flag[0].'100', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_b2_umum_p_sum));
            $sheet->setCellValue($flag[0].'101', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_c_p_sum));
            $sheet->setCellValue($flag[0].'102', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_d_p_sum));
            $sheet->setCellValue($flag[0].'103', applyZero($prev->prev_sim_pelaku_pelanggaran_sim_internasional_p_sum));
            $sheet->setCellValue($flag[0].'104', applyZero($prev->prev_sim_pelaku_pelanggaran_tanpa_sim_p_sum));
            $sheet->setCellValue($flag[0].'108', applyZero($prev->prev_lokasi_pelanggaran_pemukiman_p_sum));
            $sheet->setCellValue($flag[0].'109', applyZero($prev->prev_lokasi_pelanggaran_perbelanjaan_p_sum));
            $sheet->setCellValue($flag[0].'110', applyZero($prev->prev_lokasi_pelanggaran_perkantoran_p_sum));
            $sheet->setCellValue($flag[0].'111', applyZero($prev->prev_lokasi_pelanggaran_wisata_p_sum));
            $sheet->setCellValue($flag[0].'112', applyZero($prev->prev_lokasi_pelanggaran_industri_p_sum));
            $sheet->setCellValue($flag[0].'115', applyZero($prev->prev_lokasi_pelanggaran_status_jalan_nasional_p_sum));
            $sheet->setCellValue($flag[0].'116', applyZero($prev->prev_lokasi_pelanggaran_status_jalan_propinsi_p_sum));
            $sheet->setCellValue($flag[0].'117', applyZero($prev->prev_lokasi_pelanggaran_status_jalan_kab_kota_p_sum));
            $sheet->setCellValue($flag[0].'118', applyZero($prev->prev_lokasi_pelanggaran_status_jalan_desa_lingkungan_p_sum));
            $sheet->setCellValue($flag[0].'121', applyZero($prev->prev_lokasi_pelanggaran_fungsi_jalan_arteri_p_sum));
            $sheet->setCellValue($flag[0].'122', applyZero($prev->prev_lokasi_pelanggaran_fungsi_jalan_kolektor_p_sum));
            $sheet->setCellValue($flag[0].'123', applyZero($prev->prev_lokasi_pelanggaran_fungsi_jalan_lokal_p_sum));
            $sheet->setCellValue($flag[0].'124', applyZero($prev->prev_lokasi_pelanggaran_fungsi_jalan_lingkungan_p_sum));
            $sheet->setCellValue($flag[0].'128', applyZero($prev->prev_kecelakaan_lalin_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'129', applyZero($prev->prev_kecelakaan_lalin_jumlah_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'130', applyZero($prev->prev_kecelakaan_lalin_jumlah_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'131', applyZero($prev->prev_kecelakaan_lalin_jumlah_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'132', applyZero($prev->prev_kecelakaan_lalin_jumlah_kerugian_materiil_p_sum));
            $sheet->setCellValue($flag[0].'134', applyZero($prev->prev_kecelakaan_barang_bukti_yg_disita_sim_p_sum));
            $sheet->setCellValue($flag[0].'135', applyZero($prev->prev_kecelakaan_barang_bukti_yg_disita_stnk_p_sum));
            $sheet->setCellValue($flag[0].'136', applyZero($prev->prev_kecelakaan_barang_bukti_yg_disita_kendaraan_p_sum));
            $sheet->setCellValue($flag[0].'139', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_pns_p_sum));
            $sheet->setCellValue($flag[0].'140', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_karwayan_swasta_p_sum));
            $sheet->setCellValue($flag[0].'141', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_pelajar_mahasiswa_p_sum));
            $sheet->setCellValue($flag[0].'142', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_pengemudi_p_sum));
            $sheet->setCellValue($flag[0].'143', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_tni_p_sum));
            $sheet->setCellValue($flag[0].'144', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_polri_p_sum));
            $sheet->setCellValue($flag[0].'145', applyZero($prev->prev_profesi_korban_kecelakaan_lalin_lain_lain_p_sum));
            $sheet->setCellValue($flag[0].'148', applyZero($prev->prev_usia_korban_kecelakaan_kurang_15_p_sum));
            $sheet->setCellValue($flag[0].'149', applyZero($prev->prev_usia_korban_kecelakaan_16_20_p_sum));
            $sheet->setCellValue($flag[0].'150', applyZero($prev->prev_usia_korban_kecelakaan_21_25_p_sum));
            $sheet->setCellValue($flag[0].'151', applyZero($prev->prev_usia_korban_kecelakaan_26_30_p_sum));
            $sheet->setCellValue($flag[0].'152', applyZero($prev->prev_usia_korban_kecelakaan_31_35_p_sum));
            $sheet->setCellValue($flag[0].'153', applyZero($prev->prev_usia_korban_kecelakaan_36_40_p_sum));
            $sheet->setCellValue($flag[0].'154', applyZero($prev->prev_usia_korban_kecelakaan_41_45_p_sum));
            $sheet->setCellValue($flag[0].'155', applyZero($prev->prev_usia_korban_kecelakaan_45_50_p_sum));
            $sheet->setCellValue($flag[0].'156', applyZero($prev->prev_usia_korban_kecelakaan_51_55_p_sum));
            $sheet->setCellValue($flag[0].'157', applyZero($prev->prev_usia_korban_kecelakaan_56_60_p_sum));
            $sheet->setCellValue($flag[0].'158', applyZero($prev->prev_usia_korban_kecelakaan_diatas_60_p_sum));
            $sheet->setCellValue($flag[0].'161', applyZero($prev->prev_sim_korban_kecelakaan_sim_a_p_sum));
            $sheet->setCellValue($flag[0].'162', applyZero($prev->prev_sim_korban_kecelakaan_sim_a_umum_p_sum));
            $sheet->setCellValue($flag[0].'163', applyZero($prev->prev_sim_korban_kecelakaan_sim_b1_p_sum));
            $sheet->setCellValue($flag[0].'164', applyZero($prev->prev_sim_korban_kecelakaan_sim_b1_umum_p_sum));
            $sheet->setCellValue($flag[0].'165', applyZero($prev->prev_sim_korban_kecelakaan_sim_b2_p_sum));
            $sheet->setCellValue($flag[0].'166', applyZero($prev->prev_sim_korban_kecelakaan_sim_b2_umum_p_sum));
            $sheet->setCellValue($flag[0].'167', applyZero($prev->prev_sim_korban_kecelakaan_sim_c_p_sum));
            $sheet->setCellValue($flag[0].'168', applyZero($prev->prev_sim_korban_kecelakaan_sim_d_p_sum));
            $sheet->setCellValue($flag[0].'169', applyZero($prev->prev_sim_korban_kecelakaan_sim_internasional_p_sum));
            $sheet->setCellValue($flag[0].'170', applyZero($prev->prev_sim_korban_kecelakaan_tanpa_sim_p_sum));
            $sheet->setCellValue($flag[0].'173', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_sepeda_motor_p_sum));
            $sheet->setCellValue($flag[0].'174', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_mobil_penumpang_p_sum));
            $sheet->setCellValue($flag[0].'175', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_mobil_bus_p_sum));
            $sheet->setCellValue($flag[0].'176', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_mobil_barang_p_sum));
            $sheet->setCellValue($flag[0].'177', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_kendaraan_khusus_p_sum));
            $sheet->setCellValue($flag[0].'178', applyZero($prev->prev_kendaraan_yg_terlibat_kecelakaan_kendaraan_tidak_bermotor_p_sum));
            $sheet->setCellValue($flag[0].'181', applyZero($prev->prev_jenis_kecelakaan_tunggal_ooc_p_sum));
            $sheet->setCellValue($flag[0].'182', applyZero($prev->prev_jenis_kecelakaan_depan_depan_p_sum));
            $sheet->setCellValue($flag[0].'183', applyZero($prev->prev_jenis_kecelakaan_depan_belakang_p_sum));
            $sheet->setCellValue($flag[0].'184', applyZero($prev->prev_jenis_kecelakaan_depan_samping_p_sum));
            $sheet->setCellValue($flag[0].'185', applyZero($prev->prev_jenis_kecelakaan_beruntun_p_sum));
            $sheet->setCellValue($flag[0].'186', applyZero($prev->prev_jenis_kecelakaan_pejalan_kaki_p_sum));
            $sheet->setCellValue($flag[0].'187', applyZero($prev->prev_jenis_kecelakaan_tabrak_lari_p_sum));
            $sheet->setCellValue($flag[0].'188', applyZero($prev->prev_jenis_kecelakaan_tabrak_hewan_p_sum));
            $sheet->setCellValue($flag[0].'189', applyZero($prev->prev_jenis_kecelakaan_samping_samping_p_sum));
            $sheet->setCellValue($flag[0].'190', applyZero($prev->prev_jenis_kecelakaan_lainnya_p_sum));
            $sheet->setCellValue($flag[0].'193', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_pns_p_sum));
            $sheet->setCellValue($flag[0].'194', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_karyawan_swasta_p_sum));
            $sheet->setCellValue($flag[0].'195', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_mahasiswa_pelajar_p_sum));
            $sheet->setCellValue($flag[0].'196', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_pengemudi_p_sum));
            $sheet->setCellValue($flag[0].'197', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_tni_p_sum));
            $sheet->setCellValue($flag[0].'198', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_polri_p_sum));
            $sheet->setCellValue($flag[0].'199', applyZero($prev->prev_profesi_pelaku_kecelakaan_lalin_lain_lain_p_sum));
            $sheet->setCellValue($flag[0].'202', applyZero($prev->prev_usia_pelaku_kecelakaan_kurang_dari_15_tahun_p_sum));
            $sheet->setCellValue($flag[0].'203', applyZero($prev->prev_usia_pelaku_kecelakaan_16_20_tahun_p_sum));
            $sheet->setCellValue($flag[0].'204', applyZero($prev->prev_usia_pelaku_kecelakaan_21_25_tahun_p_sum));
            $sheet->setCellValue($flag[0].'205', applyZero($prev->prev_usia_pelaku_kecelakaan_26_30_tahun_p_sum));
            $sheet->setCellValue($flag[0].'206', applyZero($prev->prev_usia_pelaku_kecelakaan_31_35_tahun_p_sum));
            $sheet->setCellValue($flag[0].'207', applyZero($prev->prev_usia_pelaku_kecelakaan_36_40_tahun_p_sum));
            $sheet->setCellValue($flag[0].'208', applyZero($prev->prev_usia_pelaku_kecelakaan_41_45_tahun_p_sum));
            $sheet->setCellValue($flag[0].'209', applyZero($prev->prev_usia_pelaku_kecelakaan_46_50_tahun_p_sum));
            $sheet->setCellValue($flag[0].'210', applyZero($prev->prev_usia_pelaku_kecelakaan_51_55_tahun_p_sum));
            $sheet->setCellValue($flag[0].'211', applyZero($prev->prev_usia_pelaku_kecelakaan_56_60_tahun_p_sum));
            $sheet->setCellValue($flag[0].'212', applyZero($prev->prev_usia_pelaku_kecelakaan_diatas_60_tahun_p_sum));
            $sheet->setCellValue($flag[0].'215', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_a_p_sum));
            $sheet->setCellValue($flag[0].'216', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_a_umum_p_sum));
            $sheet->setCellValue($flag[0].'217', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_b1_p_sum));
            $sheet->setCellValue($flag[0].'218', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_b1_umum_p_sum));
            $sheet->setCellValue($flag[0].'219', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_b2_p_sum));
            $sheet->setCellValue($flag[0].'220', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_b2_umum_p_sum));
            $sheet->setCellValue($flag[0].'221', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_c_p_sum));
            $sheet->setCellValue($flag[0].'222', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_dn_p_sum));
            $sheet->setCellValue($flag[0].'223', applyZero($prev->prev_sim_pelaku_kecelakaan_sim_internasional_p_sum));
            $sheet->setCellValue($flag[0].'224', applyZero($prev->prev_sim_pelaku_kecelakaan_tanpa_sim_p_sum));
            $sheet->setCellValue($flag[0].'228', applyZero($prev->prev_lokasi_kecelakaan_lalin_pemukiman_p_sum));
            $sheet->setCellValue($flag[0].'229', applyZero($prev->prev_lokasi_kecelakaan_lalin_perbelanjaan_p_sum));
            $sheet->setCellValue($flag[0].'230', applyZero($prev->prev_lokasi_kecelakaan_lalin_perkantoran_p_sum));
            $sheet->setCellValue($flag[0].'231', applyZero($prev->prev_lokasi_kecelakaan_lalin_wisata_p_sum));
            $sheet->setCellValue($flag[0].'232', applyZero($prev->prev_lokasi_kecelakaan_lalin_industri_p_sum));
            $sheet->setCellValue($flag[0].'233', applyZero($prev->prev_lokasi_kecelakaan_lalin_lain_lain_p_sum));
            $sheet->setCellValue($flag[0].'236', applyZero($prev->prev_lokasi_kecelakaan_status_jalan_nasional_p_sum));
            $sheet->setCellValue($flag[0].'237', applyZero($prev->prev_lokasi_kecelakaan_status_jalan_propinsi_p_sum));
            $sheet->setCellValue($flag[0].'238', applyZero($prev->prev_lokasi_kecelakaan_status_jalan_kab_kota_p_sum));
            $sheet->setCellValue($flag[0].'239', applyZero($prev->prev_lokasi_kecelakaan_status_jalan_desa_lingkungan_p_sum));
            $sheet->setCellValue($flag[0].'242', applyZero($prev->prev_lokasi_kecelakaan_fungsi_jalan_arteri_p_sum));
            $sheet->setCellValue($flag[0].'243', applyZero($prev->prev_lokasi_kecelakaan_fungsi_jalan_kolektor_p_sum));
            $sheet->setCellValue($flag[0].'244', applyZero($prev->prev_lokasi_kecelakaan_fungsi_jalan_lokal_p_sum));
            $sheet->setCellValue($flag[0].'245', applyZero($prev->prev_lokasi_kecelakaan_fungsi_jalan_lingkungan_p_sum));
            $sheet->setCellValue($flag[0].'248', applyZero($prev->prev_faktor_penyebab_kecelakaan_manusia_p_sum));
            $sheet->setCellValue($flag[0].'249', applyZero($prev->prev_faktor_penyebab_kecelakaan_ngantuk_lelah_p_sum));
            $sheet->setCellValue($flag[0].'250', applyZero($prev->prev_faktor_penyebab_kecelakaan_mabuk_obat_p_sum));
            $sheet->setCellValue($flag[0].'251', applyZero($prev->prev_faktor_penyebab_kecelakaan_sakit_p_sum));
            $sheet->setCellValue($flag[0].'252', applyZero($prev->prev_faktor_penyebab_kecelakaan_handphone_elektronik_p_sum));
            $sheet->setCellValue($flag[0].'253', applyZero($prev->prev_faktor_penyebab_kecelakaan_menerobos_lampu_merah_p_sum));
            $sheet->setCellValue($flag[0].'254', applyZero($prev->prev_faktor_penyebab_kecelakaan_melanggar_batas_kecepatan_p_sum));
            $sheet->setCellValue($flag[0].'255', applyZero($prev->prev_faktor_penyebab_kecelakaan_tidak_menjaga_jarak_p_sum));
            $sheet->setCellValue($flag[0].'256', applyZero($prev->prev_faktor_penyebab_kecelakaan_mendahului_berbelok_pindah_jalur_p_sum));
            $sheet->setCellValue($flag[0].'257', applyZero($prev->prev_faktor_penyebab_kecelakaan_berpindah_jalur_p_sum));
            $sheet->setCellValue($flag[0].'258', applyZero($prev->prev_faktor_penyebab_kecelakaan_tidak_memberikan_lampu_isyarat_p_sum));
            $sheet->setCellValue($flag[0].'259', applyZero($prev->prev_faktor_penyebab_kecelakaan_tidak_mengutamakan_pejalan_kaki_p_sum));
            $sheet->setCellValue($flag[0].'260', applyZero($prev->prev_faktor_penyebab_kecelakaan_lainnya_p_sum));
            $sheet->setCellValue($flag[0].'261', applyZero($prev->prev_faktor_penyebab_kecelakaan_alam_p_sum));
            $sheet->setCellValue($flag[0].'262', applyZero($prev->prev_faktor_penyebab_kecelakaan_kelaikan_kendaraan_p_sum));
            $sheet->setCellValue($flag[0].'263', applyZero($prev->prev_faktor_penyebab_kecelakaan_kondisi_jalan_p_sum));
            $sheet->setCellValue($flag[0].'264', applyZero($prev->prev_faktor_penyebab_kecelakaan_prasarana_jalan_p_sum));
            $sheet->setCellValue($flag[0].'265', applyZero($prev->prev_faktor_penyebab_kecelakaan_rambu_p_sum));
            $sheet->setCellValue($flag[0].'266', applyZero($prev->prev_faktor_penyebab_kecelakaan_marka_p_sum));
            $sheet->setCellValue($flag[0].'267', applyZero($prev->prev_faktor_penyebab_kecelakaan_apil_p_sum));
            $sheet->setCellValue($flag[0].'268', applyZero($prev->prev_faktor_penyebab_kecelakaan_perlintasan_ka_palang_pintu_p_sum));
            $sheet->setCellValue($flag[0].'271', applyZero($prev->prev_waktu_kejadian_kecelakaan_00_03_p_sum));
            $sheet->setCellValue($flag[0].'272', applyZero($prev->prev_waktu_kejadian_kecelakaan_03_06_p_sum));
            $sheet->setCellValue($flag[0].'273', applyZero($prev->prev_waktu_kejadian_kecelakaan_06_09_p_sum));
            $sheet->setCellValue($flag[0].'274', applyZero($prev->prev_waktu_kejadian_kecelakaan_09_12_p_sum));
            $sheet->setCellValue($flag[0].'275', applyZero($prev->prev_waktu_kejadian_kecelakaan_12_15_p_sum));
            $sheet->setCellValue($flag[0].'276', applyZero($prev->prev_waktu_kejadian_kecelakaan_15_18_p_sum));
            $sheet->setCellValue($flag[0].'277', applyZero($prev->prev_waktu_kejadian_kecelakaan_18_21_p_sum));
            $sheet->setCellValue($flag[0].'278', applyZero($prev->prev_waktu_kejadian_kecelakaan_21_24_p_sum));
            $sheet->setCellValue($flag[0].'281', applyZero($prev->prev_kecelakaan_lalin_menonjol_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'282', applyZero($prev->prev_kecelakaan_lalin_menonjol_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'283', applyZero($prev->prev_kecelakaan_lalin_menonjol_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'284', applyZero($prev->prev_kecelakaan_lalin_menonjol_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'285', applyZero($prev->prev_kecelakaan_lalin_menonjol_materiil_p_sum));
            $sheet->setCellValue($flag[0].'287', applyZero($prev->prev_kecelakaan_lalin_tunggal_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'288', applyZero($prev->prev_kecelakaan_lalin_tunggal_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'289', applyZero($prev->prev_kecelakaan_lalin_tunggal_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'290', applyZero($prev->prev_kecelakaan_lalin_tunggal_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'291', applyZero($prev->prev_kecelakaan_lalin_tunggal_materiil_p_sum));
            $sheet->setCellValue($flag[0].'293', applyZero($prev->prev_kecelakaan_lalin_tabrak_pejalan_kaki_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'294', applyZero($prev->prev_kecelakaan_lalin_tabrak_pejalan_kaki_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'295', applyZero($prev->prev_kecelakaan_lalin_tabrak_pejalan_kaki_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'296', applyZero($prev->prev_kecelakaan_lalin_tabrak_pejalan_kaki_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'297', applyZero($prev->prev_kecelakaan_lalin_tabrak_pejalan_kaki_materiil_p_sum));
            $sheet->setCellValue($flag[0].'299', applyZero($prev->prev_kecelakaan_lalin_tabrak_lari_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'300', applyZero($prev->prev_kecelakaan_lalin_tabrak_lari_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'301', applyZero($prev->prev_kecelakaan_lalin_tabrak_lari_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'302', applyZero($prev->prev_kecelakaan_lalin_tabrak_lari_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'303', applyZero($prev->prev_kecelakaan_lalin_tabrak_lari_materiil_p_sum));
            $sheet->setCellValue($flag[0].'305', applyZero($prev->prev_kecelakaan_lalin_tabrak_sepeda_motor_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'306', applyZero($prev->prev_kecelakaan_lalin_tabrak_sepeda_motor_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'307', applyZero($prev->prev_kecelakaan_lalin_tabrak_sepeda_motor_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'308', applyZero($prev->prev_kecelakaan_lalin_tabrak_sepeda_motor_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'309', applyZero($prev->prev_kecelakaan_lalin_tabrak_sepeda_motor_materiil_p_sum));
            $sheet->setCellValue($flag[0].'311', applyZero($prev->prev_kecelakaan_lalin_tabrak_roda_empat_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'312', applyZero($prev->prev_kecelakaan_lalin_tabrak_roda_empat_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'313', applyZero($prev->prev_kecelakaan_lalin_tabrak_roda_empat_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'314', applyZero($prev->prev_kecelakaan_lalin_tabrak_roda_empat_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'315', applyZero($prev->prev_kecelakaan_lalin_tabrak_roda_empat_materiil_p_sum));
            $sheet->setCellValue($flag[0].'317', applyZero($prev->prev_kecelakaan_lalin_tabrak_tidak_bermotor_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'318', applyZero($prev->prev_kecelakaan_lalin_tabrak_tidak_bermotor_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'319', applyZero($prev->prev_kecelakaan_lalin_tabrak_tidak_bermotor_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'320', applyZero($prev->prev_kecelakaan_lalin_tabrak_tidak_bermotor_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'321', applyZero($prev->prev_kecelakaan_lalin_tabrak_tidak_bermotor_materiil_p_sum));
            $sheet->setCellValue($flag[0].'323', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_jumlah_kejadian_p_sum));
            $sheet->setCellValue($flag[0].'324', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_berpalang_pintu_p_sum));
            $sheet->setCellValue($flag[0].'325', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_tidak_berpalang_pintu_p_sum));
            $sheet->setCellValue($flag[0].'326', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_korban_luka_ringan_p_sum));
            $sheet->setCellValue($flag[0].'327', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_korban_luka_berat_p_sum));
            $sheet->setCellValue($flag[0].'328', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_korban_meninggal_p_sum));
            $sheet->setCellValue($flag[0].'329', applyZero($prev->prev_kecelakaan_lalin_perlintasan_ka_materiil_p_sum));
            $sheet->setCellValue($flag[0].'331', applyZero($prev->prev_kecelakaan_transportasi_kereta_api_p_sum));
            $sheet->setCellValue($flag[0].'332', applyZero($prev->prev_kecelakaan_transportasi_laut_perairan_p_sum));
            $sheet->setCellValue($flag[0].'333', applyZero($prev->prev_kecelakaan_transportasi_udara_p_sum));
            $sheet->setCellValue($flag[0].'337', applyZero($prev->prev_penlu_melalui_media_cetak_p_sum));
            $sheet->setCellValue($flag[0].'339', applyZero($prev->prev_penlu_melalui_media_elektronik_p_sum));
            $sheet->setCellValue($flag[0].'340', applyZero($prev->prev_penlu_melalui_media_sosial_p_sum));
            $sheet->setCellValue($flag[0].'341', applyZero($prev->prev_penlu_melalui_tempat_keramaian_p_sum));
            $sheet->setCellValue($flag[0].'342', applyZero($prev->prev_penlu_melalui_tempat_istirahat_p_sum));
            $sheet->setCellValue($flag[0].'343', applyZero($prev->prev_penlu_melalui_daerah_rawan_laka_dan_langgar_p_sum));
            $sheet->setCellValue($flag[0].'346', applyZero($prev->prev_penyebaran_pemasangan_spanduk_p_sum));
            $sheet->setCellValue($flag[0].'347', applyZero($prev->prev_penyebaran_pemasangan_leaflet_p_sum));
            $sheet->setCellValue($flag[0].'348', applyZero($prev->prev_penyebaran_pemasangan_sticker_p_sum));
            $sheet->setCellValue($flag[0].'349', applyZero($prev->prev_penyebaran_pemasangan_bilboard_p_sum));
            $sheet->setCellValue($flag[0].'352', applyZero($prev->prev_polisi_sahabat_anak_p_sum));
            $sheet->setCellValue($flag[0].'353', applyZero($prev->prev_cara_aman_sekolah_p_sum));
            $sheet->setCellValue($flag[0].'354', applyZero($prev->prev_patroli_keamanan_sekolah_p_sum));
            $sheet->setCellValue($flag[0].'355', applyZero($prev->prev_pramuka_bhayangkara_krida_lalu_lintas_p_sum));
            $sheet->setCellValue($flag[0].'358', applyZero($prev->prev_police_goes_to_campus_p_sum));
            $sheet->setCellValue($flag[0].'359', applyZero($prev->prev_safety_riding_driving_p_sum));
            $sheet->setCellValue($flag[0].'360', applyZero($prev->prev_forum_lalu_lintas_angkutan_umum_p_sum));
            $sheet->setCellValue($flag[0].'361', applyZero($prev->prev_kampanye_keselamatan_p_sum));
            $sheet->setCellValue($flag[0].'362', applyZero($prev->prev_sekolah_mengemudi_p_sum));
            $sheet->setCellValue($flag[0].'363', applyZero($prev->prev_taman_lalu_lintas_p_sum));
            $sheet->setCellValue($flag[0].'364', applyZero($prev->prev_global_road_safety_partnership_action_p_sum));
            $sheet->setCellValue($flag[0].'368', applyZero($prev->prev_giat_lantas_pengaturan_p_sum));
            $sheet->setCellValue($flag[0].'369', applyZero($prev->prev_giat_lantas_penjagaan_p_sum));
            $sheet->setCellValue($flag[0].'370', applyZero($prev->prev_giat_lantas_pengawalan_p_sum));
            $sheet->setCellValue($flag[0].'371', applyZero($prev->prev_giat_lantas_patroli_p_sum));
            $sheet->setCellValue($flag[0].'376', applyZero($prev->prev_arus_mudik_jumlah_bus_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'377', applyZero($prev->prev_arus_mudik_jumlah_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'378', applyZero($prev->prev_arus_mudik_jumlah_bus_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'379', applyZero($prev->prev_arus_mudik_jumlah_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'380', applyZero($prev->prev_arus_mudik_total_terminal_p_sum));
            $sheet->setCellValue($flag[0].'381', applyZero($prev->prev_arus_mudik_total_bus_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'382', applyZero($prev->prev_arus_mudik_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'383', applyZero($prev->prev_arus_mudik_total_bus_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'384', applyZero($prev->prev_arus_mudik_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'386', applyZero($prev->prev_arus_mudik_kereta_api_total_stasiun_p_sum));
            $sheet->setCellValue($flag[0].'387', applyZero($prev->prev_arus_mudik_kereta_api_total_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'388', applyZero($prev->prev_arus_mudik_kereta_api_total_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'390', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'391', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_keberangkatan_r4_p_sum));
            $sheet->setCellValue($flag[0].'392', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_keberangkatan_r2_p_sum));
            $sheet->setCellValue($flag[0].'393', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'394', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'395', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_kedatangan_r4_p_sum));
            $sheet->setCellValue($flag[0].'396', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_kendaraan_kedatangan_r2_p_sum));
            $sheet->setCellValue($flag[0].'397', applyZero($prev->prev_arus_mudik_pelabuhan_jumlah_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'398', applyZero($prev->prev_arus_mudik_total_pelabuhan_p_sum));
            $sheet->setCellValue($flag[0].'399', applyZero($prev->prev_arus_mudik_pelabuhan_kendaraan_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'400', applyZero($prev->prev_arus_mudik_pelabuhan_kendaraan_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'401', applyZero($prev->prev_arus_mudik_pelabuhan_total_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'402', applyZero($prev->prev_arus_mudik_pelabuhan_total_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'404', applyZero($prev->prev_arus_mudik_bandara_jumlah_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'405', applyZero($prev->prev_arus_mudik_bandara_jumlah_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'406', applyZero($prev->prev_arus_mudik_total_bandara_p_sum));
            $sheet->setCellValue($flag[0].'407', applyZero($prev->prev_arus_mudik_bandara_total_penumpang_keberangkatan_p_sum));
            $sheet->setCellValue($flag[0].'408', applyZero($prev->prev_arus_mudik_bandara_total_penumpang_kedatangan_p_sum));
            $sheet->setCellValue($flag[0].'409', applyZero($prev->prev_prokes_covid_teguran_gar_prokes_p_sum));
            $sheet->setCellValue($flag[0].'412', applyZero($prev->prev_prokes_covid_pembagian_masker_p_sum));
            $sheet->setCellValue($flag[0].'413', applyZero($prev->prev_prokes_covid_sosialisasi_tentang_prokes_p_sum));
            $sheet->setCellValue($flag[0].'414', applyZero($prev->prev_prokes_covid_giat_baksos_p_sum));
