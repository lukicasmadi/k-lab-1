...
if (! function_exists('compareAllPoldaInput')) {
    function compareAllPoldaInput($data_prev, $data_current, $start_date, $end_date, $prev_year, $current_year, $operration, $dr=null) {
        ...
        $sheet->setCellValue('A6', 'TANGGAL '.strtoupper(indonesiaDate($start_date)).' s.d. '.strtoupper(indonesiaDate($end_date)));
...
if (! function_exists('compareAllPoldaInputHTML')) {
    function compareAllPoldaInputHTML($data_prev, $data_current, $start_date, $end_date, $prev_year, $current_year, $operration, $dr=null) {
