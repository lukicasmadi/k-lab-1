...
if (! function_exists('excelTemplateDisplayNew')) {
    function excelTemplateDisplayNew($prev, $current, $prevYear, $currentYear)
    {
        ...
        $sheet->setCellValue('B5', 'LAPORAN HARIAN OPS BLA BLA BLA');
        $sheet->setCellValue('B6', 'KESATUAN : ');
        $sheet->setCellValue('B7', 'HARI/TGL : ');

        $sheet->setCellValue('C10', $prevYear);
        $sheet->setCellValue('D10', $currentYear);
        ...
        $sheet->setCellValue('D28', applyZero($current->pelanggaran_sepeda_motor_berbelok_tanpa_isyarat));
...
if (! function_exists('excelTemplateNew')) {
        ...
        )
    {
        ...
        $sheet->setCellValue('B6', $kesatuan);
        // $sheet->setCellValue('E428', indonesiaDayAndDate(date("Y-m-d")));
        // $sheet->setCellValue('E434', $nama_atasan);
        // $sheet->setCellValue('E435', $pangkat);
        // $sheet->setCellValue('E429', $jabatan);
        $sheet->setCellValue('B7', 'HARI/TGL : '.$hari_tanggal);
