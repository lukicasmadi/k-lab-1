...
class CreateViewDailyInputPrevTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("CREATE VIEW view_daily_input_prev AS SELECT sum(pelanggaran_lalu_lintas_tilang_p) as pelanggaran_lalu_lintas_tilang,
    ...
    {
        DB::statement("DROP VIEW view_daily_input_prev");
    }
}
