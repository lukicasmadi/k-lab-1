        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if (data == null) {
                        return '<td class="text-center"><span><img src="' + route('home') + '/img/90x90.jpg" class="profile-img" width="40" height="40"></span></td>'
                    } else {
                        return '<td class="text-center"><span><img src="' + route('home') + '/storage/upload/' + data + '" class="profile-img" width="40" height="40"></span></td>'
                    }
                },
                searchable: false,
            },
