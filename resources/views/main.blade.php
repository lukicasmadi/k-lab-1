                        ...
                        <div class="widget-content justify-pill">
                            <ul class="nav nav-pills2 nav-fill" id="justify-pills-tab" role="tablist">
                                <li class="nav-item mr-3">
                                    <a class="nav-link2 active" id="justify-pills-home-tab" data-toggle="pill" href="#justify-pills-home" role="tab" aria-controls="justify-pills-home" aria-selected="true">Data Absensi Polda</a>
                                </li>
                                <li class="nav-item mr-3">
                                    <a class="nav-link2" id="justify-pills-profile-tab" data-toggle="pill" href="#justify-pills-profile" role="tab" aria-controls="justify-pills-profile" aria-selected="false">Data Laporan Harian</a>
                                </li>
                                <li class="nav-item mr-3">
                                    <a class="nav-link2" id="justify-pills-contact-tab" data-toggle="pill" href="#justify-pills-contact" role="tab" aria-controls="justify-pills-contact" aria-selected="false">Data Total Laporan Harian</a>
                                </li>
                                <li class="nav-item mr-3">
                                    <a class="nav-link2" id="justify-pills-contact-tab" data-toggle="pill" href="#justify-pills-contact" role="tab" aria-controls="justify-pills-contact" aria-selected="false">Data Laporan Anev</a>
                                </li>
                                <li class="nav-item mr-3">
                                    <a class="nav-link2" id="justify-pills-contact-tab" data-toggle="pill" href="#justify-pills-contact" role="tab" aria-controls="justify-pills-contact" aria-selected="false">Data Total Laporan Anev</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link2" id="justify-pills-contact-tab" data-toggle="pill" href="#justify-pills-contact" role="tab" aria-controls="justify-pills-contact" aria-selected="false">Semua Data Laporan</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="justify-pills-tabContent">
                                                ...
                                                <div class="row">
                                                    <h5 class="ml-n3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-n1" width="20" height="20" viewBox="0 0 20 20">
                                                            <path
                                                                id="bar_chart_alt"
                                                                d="M22,22H2V11.474A2.055,2.055,0,0,1,4,9.368H8V4.105A2.055,2.055,0,0,1,10,2h4a2.055,2.055,0,0,1,2,2.105V7.263h4a2.055,2.055,0,0,1,2,2.105ZM16,9.368V19.895h4V9.368ZM10,4.105V19.895h4V4.105ZM4,11.474v8.421H8V11.474Z"
                                ...
                                <div class="tab-pane fade" id="justify-pills-contact" role="tabpanel" aria-labelledby="justify-pills-contact-tab"></div>
                            </div>
                        </div>
                    </div>
                @endif
