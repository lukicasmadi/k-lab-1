...
<div class="topbar-nav header navbar" role="banner">
    <nav id="topbar">
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li id="menuMaster" class="menu single-menu {{ request()->is('admin/category') || request()->is('admin/article') || request()->is('admin/polda') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#menuMaster">
            ...
            <li id="menuOperation" class="menu single-menu {{ request()->is('admin/operasi/*') ? 'active' : '' }}">
                <a href="#" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" data-parent="#menuOperation">
            ...
            <li id="menuReportPusat" class="menu single-menu {{ request()->is('admin/operasi/*') ? 'active' : '' }}">
                <a href="#" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" data-parent="#menuReportPusat">
                    <li class="{{ request()->is('admin/rencana-operasi') ? 'active' : '' }}">
            ...
            <li id="menuPolda" class="menu single-menu {{ request()->is('admin/operasi/*') ? 'active' : '' }}">
                <a href="#" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg>
                        <span>Reporting</span>
                ...
                <ul class="collapse submenu list-unstyled" data-parent="#menuPolda">
                    <li class="{{ request()->is('admin/rencana-operasi') ? 'active' : '' }}">
                        <a href="{{ route('rencana_operasi_index') }}"> By Date </a>
                    </li>
                    <li class="{{ request()->is('admin/rencana-operasi') ? 'active' : '' }}">
