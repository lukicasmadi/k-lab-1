    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
                        ...
                        @role('access_pusat|administrator')
                            <li class="menu single-menu {{
                                ...
                                <a href="{{ route('rencana_operasi_index') }}">
                                    <div data-step="2" data-intro="Menu Rencana Operasi digunakan untuk menambahkan rencana operasi yang akan dijalankan oleh polda <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
                            ...
                            <li class="menu single-menu {{
                                ...
                                <a href="#reportpusat" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                                    <div data-step="3" data-intro="Menu Laporan digunakan untuk membuat laporan harian, perbandingan dan download data <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
                                        <span>Laporan</span>
                                    </div>
                        ...
                        @role('access_daerah')
                            <li class="menu single-menu {{ request()->is('custom-name') ? 'active' : '' }}">
                                <a href="{{ route('polda_custom_name') }}">
                                    <div data-step="4" data-intro="Menu Rencana Operasi digunakan untuk menambahkan alias pada rencana operasi yang akan dijalankan oleh polda <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
                                        <span>RENCANA OPERASI</span>
                                    </div>
                                </a>
                            </li>
                            <li class="menu single-menu {{
                                ...
                                <a href="#reportpusat" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                                    <div data-step="5" data-intro="Menu Laporan digunakan untuk membuat laporan harian polda <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
                                        <span>Laporan</span>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                </a>
                        ...
                        @role('administrator|access_pusat')
                            <li class="menu single-menu {{
                                ...
                                <a href="#dashboard" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                                    <div class="" data-step="6" data-intro="Menu Manajemen Data untuk mengatur semua master data <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                ...
                <div class="media" data-step="7" data-intro="Menu User digunakan untuk mengubah password, profil dan keluar dari sistem <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
                        @php
                            if(!empty(auth()->user())) {
...
<div class="layout-px-spacing">
    <div class="page-header">
        @stack('page_title')
        <div class="toggle-switch" data-step="8" data-intro="Tombol mengubah tema digunakan untuk mengganti tema pada website <br /><br /> <a href='#' class='manuals'>Unduh Panduan </a>">
