...
<div class="header-container layout-px-menu">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="{{ route('dashboard') }}"><img alt="logo" src="{{ asset('img/korlantas.png') }}"> <span class="navbar-brand-name">SISTEM PELAPORAN OPERASI KORLANTAS POLRI</span></a>
        </div>
