<table>
    <thead>
        ...
        <tr>
            <td style="text-align: center;" colspan="4">LAPORAN HARIAN {{ \Illuminate\Support\Str::upper($operation->name) }} POLDA {{ \Illuminate\Support\Str::upper($polda) }}</td>
        </tr>
        <tr>
            <td style="text-align: center;" colspan="4">TANGGAL: {{ $operation->start_date->format("Y-m-d") }} S/D {{ $operation->end_date->format("Y-m-d") }}</td>
        </tr>
        <tr>
