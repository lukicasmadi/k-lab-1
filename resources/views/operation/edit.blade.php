                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                            <h4>Edit Operation Plan</h4>
                        </div>
                    </div>
                </div>

                <div class="widget-content widget-content-area">
                    <form method="POST" action="{{ route('rencana_operasi_update', $data->uuid) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('operation_type') is-invalid @enderror" id="operation_type" name="operation_type" placeholder="Operation Type" autocomplete="off" value="{{ $data->operation_type }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('desc') is-invalid @enderror" id="desc" name="desc" rows="10">{{ $data->desc }}</textarea>
                            @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control flatpickr flatpickr-input active @error('operation_periode') is-invalid @enderror" id="operation_periode" name="operation_periode" placeholder="Operation Date Range" autocomplete="off" value="{{ $data->start_date }} to {{ $data->end_date }}">
