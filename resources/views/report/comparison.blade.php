                ...
                <div class="table-responsive">
                    <table id="tbl_daily_submited" class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="evaluasi">
                                <td>Melawan Arus</td>
                                <td id="pelanggaran_lalin_motor_lawan_arus_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_motor_gunhp_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_motor_pengaruh_alkohol_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_motor_batas_kecepatan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_motor_bawah_umur_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Lain - Lain</td>
                                <td id="pelanggaran_lalin_motor_lain_lain_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Melawan Arus</td>
                                <td id="pelanggaran_lalin_mobil_lawan_arus_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Gun HP Saat Berkendara</td>
                                <td id="pelanggaran_lalin_mobil_gunhp_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Berkendara Di Bawah Pengaruh Alkohol</td>
                                <td id="pelanggaran_lalin_mobil_pengaruh_alkohol_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Melebihi Batas Kecepatan</td>
                                <td id="pelanggaran_lalin_mobil_batas_kecepatan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Berkendara Di Bawah Umur</td>
                                <td id="pelanggaran_lalin_mobil_bawah_umur_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_mobil_gunsafety_belt_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Lain - Lain</td>
                                <td id="pelanggaran_lalin_mobil_lain_lain_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>SIM</td>
                                <td id="pelanggaran_lalin_barang_bukti_sim_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>STNK</td>
                                <td id="pelanggaran_lalin_barang_bukti_stnk_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Kendaraan</td>
                                <td id="pelanggaran_lalin_barang_bukti_kendaraan_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>sepeda motor</td>
                                <td id="pelanggaran_lalin_terlibat_pelanggaran_motor_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_terlibat_pelanggaran_mob_png_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>mobil bus</td>
                                <td id="pelanggaran_lalin_terlibat_pelanggaran_bus_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>mobil barang</td>
                                <td id="pelanggaran_lalin_terlibat_pelanggaran_mob_brg_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_terlibat_pelanggaran_khusus_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_profesi_pelaku_pns_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_profesi_pelaku_swasta_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_profesi_pelaku_pelajar_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_profesi_pelaku_supir_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>TNI</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_tni_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>POLRI</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_polri_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>lain - lain</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_lainnya_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>< 15 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_15tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>16 - 20 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_1620tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>21 - 25 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_2125tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>26 - 30 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_2630tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>31 - 35 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_3135tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>36 - 40 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_3640tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>41 - 45 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_4145tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>46 - 50 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_4650tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>51 - 55 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_5155tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>56 - 60 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_5660tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>> 60 Tahun</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_60tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>A</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_a_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>A Umum</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_a_umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B1</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_b1_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B1 Umum</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_b1umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>BII</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_bii_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B II Umum</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_bii_umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>C</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_c_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>D</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_d_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                ...
                                <td id="pelanggaran_lalin_profesi_pelaku_sim_internasional_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>Tanpa SIM</td>
                                <td id="pelanggaran_lalin_profesi_pelaku_tanpa_sim_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_kawasan_pemukiman_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_kawasan_perbelanjaan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>perkantoran</td>
                                <td id="pelanggaran_lalin_kawasan_perkantoran_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_kawasan_wisata_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_kawasan_industri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>nasional</td>
                                <td id="pelanggaran_lalin_status_jalan_nasional_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>propinsi</td>
                                <td id="pelanggaran_lalin_status_jalan_propinsi_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kab/kota</td>
                                <td id="pelanggaran_lalin_status_jalan_kabkota_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="pelanggaran_lalin_status_jalan_desa_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>arteri</td>
                                <td id="pelanggaran_lalin_status_jalan_arteri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kolektor</td>
                                <td id="pelanggaran_lalin_status_jalan_kolektor_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lokal</td>
                                <td id="pelanggaran_lalin_status_jalan_lokal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lingkungan</td>
                                <td id="pelanggaran_lalin_status_jalan_lingkungan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_korban_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_korban_lukaberat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_korban_lukaringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_kerugian_materil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>SIM</td>
                                <td id="kecelakaan_lalin_barbuk_sim_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>STNK</td>
                                <td id="kecelakaan_lalin_barbuk_stnk_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kendaraan</td>
                                <td id="kecelakaan_lalin_barbuk_kendaraan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>karyawan / swasta</td>
                                <td id="kecelakaan_lalin_swasta_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pelajar / mahasiswa</td>
                                <td id="kecelakaan_lalin_pelajar_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pengemudi</td>
                                <td id="kecelakaan_lalin_pengemudi_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>TNI</td>
                                <td id="kecelakaan_lalin_tni_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>POLRI</td>
                                <td id="kecelakaan_lalin_polri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lain - lain</td>
                                <td id="kecelakaan_lalin_lain_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>< 15 Tahun</td>
                                <td id="kecelakaan_lalin_15tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>16 - 20 Tahun</td>
                                <td id="kecelakaan_lalin_1620tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>21 - 25 Tahun</td>
                                <td id="kecelakaan_lalin_2125tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>26 - 30 Tahun</td>
                                <td id="kecelakaan_lalin_2630tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>31 - 35 Tahun</td>
                                <td id="kecelakaan_lalin_3135tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>36 - 40 Tahun</td>
                                <td id="kecelakaan_lalin_3640tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>41 - 45 Tahun</td>
                                <td id="kecelakaan_lalin_4145tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>46 - 50 Tahun</td>
                                <td id="kecelakaan_lalin_4650tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>51 - 55 Tahun</td>
                                <td id="kecelakaan_lalin_5155tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>56 - 60 Tahun</td>
                                <td id="kecelakaan_lalin_5660tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>> 60 Tahun</td>
                                <td id="kecelakaan_lalin_60tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>A</td>
                                <td id="kecelakaan_lalin_sima_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>A Umum</td>
                                <td id="kecelakaan_lalin_sima_umum_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>B1</td>
                                <td id="kecelakaan_lalin_b1_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>B1 Umum</td>
                                <td id="kecelakaan_lalin_b1umum_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>BII</td>
                                <td id="kecelakaan_lalin_bii_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>BII Umum</td>
                                <td id="kecelakaan_lalin_bii_umum_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>C</td>
                                <td id="kecelakaan_lalin_simc_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>D</td>
                                <td id="kecelakaan_lalin_simd_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>SIM Internasional</td>
                                <td id="kecelakaan_lalin_sim_internasional_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Tanpa SIM</td>
                                <td id="kecelakaan_lalin_tanpa_sim_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>sepeda motor</td>
                                <td id="kecelakaan_lalin_motor_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>mobil penumpang</td>
                                <td id="kecelakaan_lalin_mobil_penumpang_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>mobil bus</td>
                                <td id="kecelakaan_lalin_bus_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>mobil barang</td>
                                <td id="kecelakaan_lalin_barang_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Kendaraan Khusus</td>
                                <td id="kecelakaan_lalin_kendaraankhusus_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_tidak_bermotor_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_tunggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>depan-depan</td>
                                <td id="kecelakaan_lalin_depan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_depan_belakang_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>depan-samping</td>
                                <td id="kecelakaan_lalin_depan_samping_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>beruntun</td>
                                <td id="kecelakaan_lalin_beruntun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_pejalan_kaki_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>tabrak lari</td>
                                <td id="kecelakaan_lalin_tabrak_lari_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>tabrak hewan</td>
                                <td id="kecelakaan_lalin_tabrak_hewan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_samping_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lainnya</td>
                                <td id="kecelakaan_lalin_lainnya_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pegawai negeri sipil</td>
                                <td id="kecelakaan_lalin_pelaku_pns_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>karyawan / swasta</td>
                                <td id="kecelakaan_lalin_pelaku_swasta_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pelajar / mahasiswa</td>
                                <td id="kecelakaan_lalin_pelaku_pelajar_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pengemudi</td>
                                <td id="kecelakaan_lalin_pelaku_pengemudi_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>TNI</td>
                                <td id="kecelakaan_lalin_pelaku_tni_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>POLRI</td>
                                <td id="kecelakaan_lalin_pelaku_polri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lain - lain</td>
                                <td id="kecelakaan_lalin_pelaku_lain_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>< 15 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_15tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>16 - 20 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_1620tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>21 - 25 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_2125tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>26 - 30 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_2630tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>31 - 35 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_3135tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>36 - 40 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_3640tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>41 - 45 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_4145tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>46 - 50 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_4650tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>51 - 55 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_5155tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>56 - 60 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_5660tahun_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>> 60 Tahun</td>
                                <td id="kecelakaan_lalin_pelaku_60tahun_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>A</td>
                                <td id="kecelakaan_lalin_pelaku_sim_a_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>A Umum</td>
                                <td id="kecelakaan_lalin_pelaku_sim_a_umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B1</td>
                                <td id="kecelakaan_lalin_pelaku_sim_b1_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B1 Umum</td>
                                <td id="kecelakaan_lalin_pelaku_sim_b1umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>BII</td>
                                <td id="kecelakaan_lalin_pelaku_sim_bii_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>B II Umum</td>
                                <td id="kecelakaan_lalin_pelaku_sim_bii_umum_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>C</td>
                                <td id="kecelakaan_lalin_pelaku_sim_c_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>D</td>
                                <td id="kecelakaan_lalin_pelaku_sim_d_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>SIM Internasional</td>
                                <td id="kecelakaan_lalin_pelaku_sim_sim_internasional_p">0</td>
                            ...
                            <tr class="evaluasi comreport">
                                <td>Tanpa SIM</td>
                                <td id="kecelakaan_lalin_pelaku_sim_tanpa_sim_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kawasan pemukiman</td>
                                <td id="kecelakaan_lalin_kawasan_pemukiman_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kawasan perbelanjaan</td>
                                <td id="kecelakaan_lalin_kawasan_perbelanjaan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>perkantoran</td>
                                <td id="kecelakaan_lalin_kawasan_perkantoran_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kawasan wisata</td>
                                <td id="kecelakaan_lalin_kawasan_wisata_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kawasan industri</td>
                                <td id="kecelakaan_lalin_kawasan_industri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>Lain - Lain</td>
                                <td id="kecelakaan_lalin_kawasan_lainlain_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>nasional</td>
                                <td id="kecelakaan_lalin_status_jalan_nasional_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>propinsi</td>
                                <td id="kecelakaan_lalin_status_jalan_propinsi_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kab/kota</td>
                                <td id="kecelakaan_lalin_status_jalan_kabkota_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>desa / lingkungan</td>
                                <td id="kecelakaan_lalin_status_jalan_desa_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>arteri</td>
                                <td id="kecelakaan_lalin_status_jalan_arteri_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>kolektor</td>
                                <td id="kecelakaan_lalin_status_jalan_kolektor_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lokal</td>
                                <td id="kecelakaan_lalin_status_jalan_lokal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lingkungan</td>
                                <td id="kecelakaan_lalin_status_jalan_lingkungan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td class="subtitle" id="kecelakaan_lalin_penyebab_manusia_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_ngantuk_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_mabuk_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>sakit (PSL 283)</td>
                                <td id="kecelakaan_lalin_penyebab_sakit_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_hp_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_lampu_merah_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_batas_cepat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_jaga_jarak_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_pindah_jalur_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_pindah_lajur_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_lampu_isyarat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_pejalan_kaki_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>lainnya</td>
                                <td id="kecelakaan_lalin_penyebab_lainnya_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td class="subtitle" id="kecelakaan_lalin_penyebab_alam_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td class="subtitle" id="kecelakaan_lalin_penyebab_kendaraan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td class="subtitle" id="kecelakaan_lalin_penyebab_kondisi_jalan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td class="subtitle" id="kecelakaan_lalin_penyebab_prasarana_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>rambu</td>
                                <td id="kecelakaan_lalin_penyebab_prasarana_rambu_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>makna</td>
                                <td id="kecelakaan_lalin_penyebab_prasarana_makna_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>apil</td>
                                <td id="kecelakaan_lalin_penyebab_prasarana_apil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_penyebab_prasarana_palangpintu_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>00.00 - 03.00</td>
                                <td id="kecelakaan_lalin_waktu_0003_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>03.00 - 06.00</td>
                                <td id="kecelakaan_lalin_waktu_0306_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>06.00 - 09.00</td>
                                <td id="kecelakaan_lalin_waktu_0609_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>09.00 - 12.00</td>
                                <td id="kecelakaan_lalin_waktu_0912_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>12.00 - 15.00</td>
                                <td id="kecelakaan_lalin_waktu_1215_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>15.00 - 18.00</td>
                                <td id="kecelakaan_lalin_waktu_1518_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>18.00 - 21.00</td>
                                <td id="kecelakaan_lalin_waktu_1821_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>21.00 - 24.00</td>
                                <td id="kecelakaan_lalin_waktu_2124_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_menonjol_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_menonjol_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_menonjol_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_menonjol_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_tunggal_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_tunggal_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_tunggal_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_tunggal_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_jalan_kaki_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_jalan_kaki_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_jalan_kaki_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_jalan_kaki_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>materiil</td>
                                <td id="kecelakaan_lalin_jalan_kaki_materiil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_tabrak_lari_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_tabrak_lari_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_tabrak_lari_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_tabrak_lari_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_tabrak_motor_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_tabrak_motor_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_tabrak_motor_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_tabrak_motor_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>materiil</td>
                                <td id="kecelakaan_lalin_tabrak_motor_materiil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_tabrak_roda4_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_tabrak_roda4_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_tabrak_roda4_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_tabrak_roda4_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>materiil</td>
                                <td id="kecelakaan_lalin_tabrak_roda4_materiil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_tidak_motor_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_tidak_motor_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_tidak_motor_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_tidak_motor_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>materiil</td>
                                <td id="kecelakaan_lalin_tidak_motor_materiil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>jumlah kejadian</td>
                                <td id="kecelakaan_lalin_pelintasan_ka_kejadian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_pelintasan_ka_berpalang_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_pelintasan_ka_tidak_berpalang_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka ringan</td>
                                <td id="kecelakaan_lalin_pelintasan_ka_luka_ringan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban luka berat</td>
                                <td id="kecelakaan_lalin_pelintasan_ka_luka_berat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>korban meninggal dunia</td>
                                <td id="kecelakaan_lalin_pelintasan_ka_meninggal_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>materiil</td>
                                <td id="kecelakaan_lalin_pelintasan_ka_materiil_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_transportasi_ka_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_transportasi_laut_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="kecelakaan_lalin_transportasi_udara_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_cetak_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_elektronik_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_keramaian_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_istirahat_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_langgar_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>spanduk</td>
                                <td id="dikmas_lantas_penluh_spanduk_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>leaflet</td>
                                <td id="dikmas_lantas_penluh_leaflet_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>sticker</td>
                                <td id="dikmas_lantas_penluh_sticker_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>bilboard</td>
                                <td id="dikmas_lantas_penluh_bilboard_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_polisi_anak_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_cara_aman_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_patroli_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_pramuka_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_police_campus_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_safety_riding_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_forum_lalin_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_kampanye_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_mengemudi_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_taman_lalin_p">0</td>
                            ...
                            <tr class="evaluasi">
                                ...
                                <td id="dikmas_lantas_penluh_global_road_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pengaturan</td>
                                <td id="dikmas_lantas_giatlantas_pengaturan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>penjagaan</td>
                                <td id="dikmas_lantas_giatlantas_penjagaan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>pengawalan</td>
                                <td id="dikmas_lantas_giatlantas_pengawalan_p">0</td>
                            ...
                            <tr class="evaluasi">
                                <td>patroli</td>
                                <td id="dikmas_lantas_giatlantas_patroli_p">0</td>
            ...
            onClose: function(selectedDates, dateStr, instance) {
                if(dateStr) {
                    ...
                    axios.post(route('comparison_get_data'), {
                        ...
                        $("#pelanggaran_lalin_motor_lawan_arus_p").html(dataPrev.pelanggaran_sepeda_motor_melawan_arus)
                        ...
                        $("#pelanggaran_lalin_motor_gunhp_p").html(dataPrev.pelanggaran_sepeda_motor_gun_hp_saat_berkendara)
                        ...
                        $("#pelanggaran_lalin_motor_pengaruh_alkohol_p").html(dataPrev.pelanggaran_sepeda_motor_berkendara_dibawah_pengaruh_alkohol)
                        ...
                        $("#pelanggaran_lalin_motor_batas_kecepatan_p").html(dataPrev.pelanggaran_sepeda_motor_melebihi_batas_kecepatan)
                        ...
                        $("#pelanggaran_lalin_motor_bawah_umur_p").html(dataPrev.pelanggaran_sepeda_motor_berkendara_dibawah_umur)
                        ...
                        $("#pelanggaran_lalin_motor_lain_lain_p").html(dataPrev.pelanggaran_sepeda_motor_lain_lain)
                        ...
                        $("#pelanggaran_lalin_mobil_lawan_arus_p").html(dataPrev.pelanggaran_mobil_melawan_arus)
                        ...
                        $("#pelanggaran_lalin_mobil_gunhp_p").html(dataPrev.pelanggaran_mobil_gun_hp_saat_berkendara)
                        ...
                        $("#pelanggaran_lalin_mobil_pengaruh_alkohol_p").html(dataPrev.pelanggaran_mobil_berkendara_dibawah_pengaruh_alkohol)
                        ...
                        $("#pelanggaran_lalin_mobil_batas_kecepatan_p").html(dataPrev.pelanggaran_mobil_melebihi_batas_kecepatan)
                        ...
                        $("#pelanggaran_lalin_mobil_bawah_umur_p").html(dataPrev.pelanggaran_mobil_berkendara_dibawah_umur)
                        ...
                        $("#pelanggaran_lalin_mobil_gunsafety_belt_p").html(dataPrev.pelanggaran_mobil_gun_safety_belt)
                        ...
                        $("#pelanggaran_lalin_mobil_lain_lain_p").html(dataPrev.pelanggaran_mobil_lain_lain)
                        ...
                        $("#pelanggaran_lalin_barang_bukti_sim_p").html(dataPrev.barang_bukti_yg_disita_sim)
                        ...
                        $("#pelanggaran_lalin_barang_bukti_stnk_p").html(dataPrev.barang_bukti_yg_disita_stnk)
                        ...
                        $("#pelanggaran_lalin_barang_bukti_kendaraan_p").html(dataPrev.barang_bukti_yg_disita_kendaraan)
                        ...
                        $("#pelanggaran_lalin_terlibat_pelanggaran_motor_p").html(dataPrev.kendaraan_yang_terlibat_pelanggaran_sepeda_motor)
                        ...
                        $("#pelanggaran_lalin_terlibat_pelanggaran_mob_png_p").html(dataPrev.kendaraan_yang_terlibat_pelanggaran_mobil_penumpang)
                        ...
                        $("#pelanggaran_lalin_terlibat_pelanggaran_bus_p").html(dataPrev.kendaraan_yang_terlibat_pelanggaran_mobil_bus)
                        ...
                        $("#pelanggaran_lalin_terlibat_pelanggaran_mob_brg_p").html(dataPrev.kendaraan_yang_terlibat_pelanggaran_mobil_barang)
                        ...
                        $("#pelanggaran_lalin_terlibat_pelanggaran_khusus_p").html(dataPrev.kendaraan_yang_terlibat_pelanggaran_kendaraan_khusus)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_pns_p").html(dataPrev.profesi_pelaku_pelanggaran_pns)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_swasta_p").html(dataPrev.profesi_pelaku_pelanggaran_karyawan_swasta)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_pelajar_p").html(dataPrev.profesi_pelaku_pelanggaran_pelajar_mahasiswa)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_supir_p").html(dataPrev.profesi_pelaku_pelanggaran_pengemudi_supir)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_tni_p").html(dataPrev.profesi_pelaku_pelanggaran_tni)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_polri_p").html(dataPrev.profesi_pelaku_pelanggaran_polri)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_lainnya_p").html(dataPrev.profesi_pelaku_pelanggaran_lain_lain)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_15tahun_p").html(dataPrev.usia_pelaku_pelanggaran_kurang_dari_15_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_1620tahun_p").html(dataPrev.usia_pelaku_pelanggaran_16_20_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_2125tahun_p").html(dataPrev.usia_pelaku_pelanggaran_21_25_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_2630tahun_p").html(dataPrev.usia_pelaku_pelanggaran_26_30_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_3135tahun_p").html(dataPrev.usia_pelaku_pelanggaran_31_35_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_3640tahun_p").html(dataPrev.usia_pelaku_pelanggaran_36_40_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_4145tahun_p").html(dataPrev.usia_pelaku_pelanggaran_41_45_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_4650tahun_p").html(dataPrev.usia_pelaku_pelanggaran_46_50_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_5155tahun_p").html(dataPrev.usia_pelaku_pelanggaran_51_55_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_5660tahun_p").html(dataPrev.usia_pelaku_pelanggaran_56_60_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_60tahun_p").html(dataPrev.usia_pelaku_pelanggaran_diatas_60_tahun)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_a_p").html(dataPrev.sim_pelaku_pelanggaran_sim_a)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_a_umum_p").html(dataPrev.sim_pelaku_pelanggaran_sim_a_umum)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_b1_p").html(dataPrev.sim_pelaku_pelanggaran_sim_b1)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_b1umum_p").html(dataPrev.sim_pelaku_pelanggaran_sim_b1_umum)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_bii_p").html(dataPrev.sim_pelaku_pelanggaran_sim_b2)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_bii_umum_p").html(dataPrev.sim_pelaku_pelanggaran_sim_b2_umum)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_c_p").html(dataPrev.sim_pelaku_pelanggaran_sim_c)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_d_p").html(dataPrev.sim_pelaku_pelanggaran_sim_d)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_sim_internasional_p").html(dataPrev.sim_pelaku_pelanggaran_sim_internasional)
                        ...
                        $("#pelanggaran_lalin_profesi_pelaku_tanpa_sim_p").html(dataPrev.sim_pelaku_pelanggaran_tanpa_sim)
                        ...
                        $("#pelanggaran_lalin_kawasan_pemukiman_p").html(dataPrev.lokasi_pelanggaran_pemukiman)
                        ...
                        $("#pelanggaran_lalin_kawasan_perbelanjaan_p").html(dataPrev.lokasi_pelanggaran_perbelanjaan)
                        ...
                        $("#pelanggaran_lalin_kawasan_perkantoran_p").html(dataPrev.lokasi_pelanggaran_perkantoran)
                        ...
                        $("#pelanggaran_lalin_kawasan_wisata_p").html(dataPrev.lokasi_pelanggaran_wisata)
                        ...
                        $("#pelanggaran_lalin_kawasan_industri_p").html(dataPrev.lokasi_pelanggaran_industri)
                        ...
                        $("#pelanggaran_lalin_status_jalan_nasional_p").html(dataPrev.lokasi_pelanggaran_status_jalan_nasional)
                        ...
                        $("#pelanggaran_lalin_status_jalan_propinsi_p").html(dataPrev.lokasi_pelanggaran_status_jalan_propinsi)
                        ...
                        $("#pelanggaran_lalin_status_jalan_kabkota_p").html(dataPrev.lokasi_pelanggaran_status_jalan_kab_kota)
                        ...
                        $("#pelanggaran_lalin_status_jalan_desa_p").html(dataPrev.lokasi_pelanggaran_status_jalan_desa_lingkungan)
                        ...
                        $("#pelanggaran_lalin_status_jalan_arteri_p").html(dataPrev.lokasi_pelanggaran_fungsi_jalan_arteri)
                        ...
                        $("#pelanggaran_lalin_status_jalan_kolektor_p").html(dataPrev.lokasi_pelanggaran_fungsi_jalan_kolektor)
                        ...
                        $("#pelanggaran_lalin_status_jalan_lokal_p").html(dataPrev.lokasi_pelanggaran_fungsi_jalan_lokal)
                        ...
                        $("#pelanggaran_lalin_status_jalan_lingkungan_p").html(dataPrev.lokasi_pelanggaran_fungsi_jalan_lingkungan)
                        ...
                        $("#kecelakaan_lalin_jumlah_kejadian_p").html(dataPrev.xxxxxxxx)
                        ...
                        $("#kecelakaan_lalin_korban_meninggal_p").html(dataPrev.kecelakaan_lalin_jumlah_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_korban_lukaberat_p").html(dataPrev.kecelakaan_lalin_jumlah_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_korban_lukaringan_p").html(dataPrev.kecelakaan_lalin_jumlah_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_kerugian_materil_p").html(dataPrev.kecelakaan_lalin_jumlah_kerugian_materiil)
                        ...
                        $("#kecelakaan_lalin_barbuk_sim_p").html(dataPrev.kecelakaan_barang_bukti_yg_disita_sim)
                        ...
                        $("#kecelakaan_lalin_barbuk_stnk_p").html(dataPrev.kecelakaan_barang_bukti_yg_disita_stnk)
                        ...
                        $("#kecelakaan_lalin_barbuk_kendaraan_p").html(dataPrev.kecelakaan_barang_bukti_yg_disita_kendaraan)
                        ...
                        $("#kecelakaan_lalin_pns_p").html(dataPrev.profesi_korban_kecelakaan_lalin_pns)
                        ...
                        $("#kecelakaan_lalin_swasta_p").html(dataPrev.profesi_korban_kecelakaan_lalin_karwayan_swasta)
                        ...
                        $("#kecelakaan_lalin_pelajar_p").html(dataPrev.profesi_korban_kecelakaan_lalin_pelajar_mahasiswa)
                        ...
                        $("#kecelakaan_lalin_pengemudi_p").html(dataPrev.profesi_korban_kecelakaan_lalin_pengemudi)
                        ...
                        $("#kecelakaan_lalin_tni_p").html(dataPrev.profesi_korban_kecelakaan_lalin_tni)
                        ...
                        $("#kecelakaan_lalin_polri_p").html(dataPrev.profesi_korban_kecelakaan_lalin_polri)
                        ...
                        $("#kecelakaan_lalin_lain_p").html(dataPrev.profesi_korban_kecelakaan_lalin_lain_lain)
                        ...
                        $("#kecelakaan_lalin_15tahun_p").html(dataPrev.usia_korban_kecelakaan_kurang_15)
                        ...
                        $("#kecelakaan_lalin_1620tahun_p").html(dataPrev.usia_korban_kecelakaan_16_20)
                        ...
                        $("#kecelakaan_lalin_2125tahun_p").html(dataPrev.usia_korban_kecelakaan_21_25)
                        ...
                        $("#kecelakaan_lalin_2630tahun_p").html(dataPrev.usia_korban_kecelakaan_26_30)
                        ...
                        $("#kecelakaan_lalin_3135tahun_p").html(dataPrev.usia_korban_kecelakaan_31_35)
                        ...
                        $("#kecelakaan_lalin_3640tahun_p").html(dataPrev.usia_korban_kecelakaan_36_40)
                        ...
                        $("#kecelakaan_lalin_4145tahun_p").html(dataPrev.usia_korban_kecelakaan_41_45)
                        ...
                        $("#kecelakaan_lalin_4650tahun_p").html(dataPrev.usia_korban_kecelakaan_45_50)
                        ...
                        $("#kecelakaan_lalin_5155tahun_p").html(dataPrev.usia_korban_kecelakaan_51_55)
                        ...
                        $("#kecelakaan_lalin_5660tahun_p").html(dataPrev.usia_korban_kecelakaan_56_60)
                        ...
                        $("#kecelakaan_lalin_60tahun_p").html(dataPrev.usia_korban_kecelakaan_diatas_60)
                        ...
                        $("#kecelakaan_lalin_sima_p").html(dataPrev.sim_korban_kecelakaan_sim_a)
                        ...
                        $("#kecelakaan_lalin_sima_umum_p").html(dataPrev.sim_korban_kecelakaan_sim_a_umum)
                        ...
                        $("#kecelakaan_lalin_b1_p").html(dataPrev.sim_korban_kecelakaan_sim_b1)
                        ...
                        $("#kecelakaan_lalin_b1umum_p").html(dataPrev.sim_korban_kecelakaan_sim_b1_umum)
                        ...
                        $("#kecelakaan_lalin_bii_p").html(dataPrev.sim_korban_kecelakaan_sim_b2)
                        ...
                        $("#kecelakaan_lalin_bii_umum_p").html(dataPrev.sim_korban_kecelakaan_sim_b2_umum)
                        ...
                        $("#kecelakaan_lalin_simc_p").html(dataPrev.sim_korban_kecelakaan_sim_c)
                        ...
                        $("#kecelakaan_lalin_simd_p").html(dataPrev.sim_korban_kecelakaan_sim_d)
                        ...
                        $("#kecelakaan_lalin_sim_internasional_p").html(dataPrev.sim_korban_kecelakaan_sim_internasional)
                        ...
                        $("#kecelakaan_lalin_tanpa_sim_p").html(dataPrev.sim_korban_kecelakaan_tanpa_sim)
                        ...
                        $("#kecelakaan_lalin_motor_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_sepeda_motor)
                        ...
                        $("#kecelakaan_lalin_mobil_penumpang_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_mobil_penumpang)
                        ...
                        $("#kecelakaan_lalin_bus_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_mobil_bus)
                        ...
                        $("#kecelakaan_lalin_barang_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_mobil_barang)
                        ...
                        $("#kecelakaan_lalin_kendaraankhusus_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_kendaraan_khusus)
                        ...
                        $("#kecelakaan_lalin_tidak_bermotor_p").html(dataPrev.kendaraan_yg_terlibat_kecelakaan_kendaraan_tidak_bermotor)
                        ...
                        $("#kecelakaan_lalin_tunggal_p").html(dataPrev.jenis_kecelakaan_tunggal_ooc)
                        ...
                        $("#kecelakaan_lalin_depan_p").html(dataPrev.jenis_kecelakaan_depan_depan)
                        ...
                        $("#kecelakaan_lalin_depan_belakang_p").html(dataPrev.jenis_kecelakaan_depan_belakang)
                        ...
                        $("#kecelakaan_lalin_depan_samping_p").html(dataPrev.jenis_kecelakaan_depan_samping)
                        ...
                        $("#kecelakaan_lalin_beruntun_p").html(dataPrev.jenis_kecelakaan_beruntun)
                        ...
                        $("#kecelakaan_lalin_pejalan_kaki_p").html(dataPrev.jenis_kecelakaan_pejalan_kaki)
                        ...
                        $("#kecelakaan_lalin_tabrak_lari_p").html(dataPrev.jenis_kecelakaan_tabrak_lari)
                        ...
                        $("#kecelakaan_lalin_tabrak_hewan_p").html(dataPrev.jenis_kecelakaan_tabrak_hewan)
                        ...
                        $("#kecelakaan_lalin_samping_p").html(dataPrev.jenis_kecelakaan_samping_samping)
                        ...
                        $("#kecelakaan_lalin_lainnya_p").html(dataPrev.jenis_kecelakaan_lainnya)
                        ...
                        $("#kecelakaan_lalin_pelaku_pns_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_pns)
                        ...
                        $("#kecelakaan_lalin_pelaku_swasta_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_karyawan_swasta)
                        ...
                        $("#kecelakaan_lalin_pelaku_pelajar_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_mahasiswa_pelajar)
                        ...
                        $("#kecelakaan_lalin_pelaku_pengemudi_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_pengemudi)
                        ...
                        $("#kecelakaan_lalin_pelaku_tni_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_tni)
                        ...
                        $("#kecelakaan_lalin_pelaku_polri_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_polri)
                        ...
                        $("#kecelakaan_lalin_pelaku_lain_p").html(dataPrev.profesi_pelaku_kecelakaan_lalin_lain_lain)
                        ...
                        $("#kecelakaan_lalin_pelaku_15tahun_p").html(dataPrev.usia_pelaku_kecelakaan_kurang_dari_15_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_1620tahun_p").html(dataPrev.usia_pelaku_kecelakaan_16_20_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_2125tahun_p").html(dataPrev.usia_pelaku_kecelakaan_21_25_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_2630tahun_p").html(dataPrev.usia_pelaku_kecelakaan_26_30_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_3135tahun_p").html(dataPrev.usia_pelaku_kecelakaan_31_35_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_3640tahun_p").html(dataPrev.usia_pelaku_kecelakaan_36_40_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_4145tahun_p").html(dataPrev.usia_pelaku_kecelakaan_41_45_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_4650tahun_p").html(dataPrev.usia_pelaku_kecelakaan_46_50_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_5155tahun_p").html(dataPrev.usia_pelaku_kecelakaan_51_55_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_5660tahun_p").html(dataPrev.usia_pelaku_kecelakaan_56_60_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_60tahun_p").html(dataPrev.usia_pelaku_kecelakaan_diatas_60_tahun)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_a_p").html(dataPrev.sim_pelaku_kecelakaan_sim_a)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_a_umum_p").html(dataPrev.sim_pelaku_kecelakaan_sim_a_umum)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_b1_p").html(dataPrev.sim_pelaku_kecelakaan_sim_b1)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_b1umum_p").html(dataPrev.sim_pelaku_kecelakaan_sim_b1_umum)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_bii_p").html(dataPrev.sim_pelaku_kecelakaan_sim_b2)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_bii_umum_p").html(dataPrev.sim_pelaku_kecelakaan_sim_b2_umum)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_c_p").html(dataPrev.sim_pelaku_kecelakaan_sim_c)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_d_p").html(dataPrev.sim_pelaku_kecelakaan_sim_d)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_sim_internasional_p").html(dataPrev.sim_pelaku_kecelakaan_sim_internasional)
                        ...
                        $("#kecelakaan_lalin_pelaku_sim_tanpa_sim_p").html(dataPrev.sim_pelaku_kecelakaan_tanpa_sim)
                        ...
                        $("#kecelakaan_lalin_kawasan_pemukiman_p").html(dataPrev.lokasi_kecelakaan_lalin_pemukiman)
                        ...
                        $("#kecelakaan_lalin_kawasan_perbelanjaan_p").html(dataPrev.lokasi_kecelakaan_lalin_perbelanjaan)
                        ...
                        $("#kecelakaan_lalin_kawasan_perkantoran_p").html(dataPrev.lokasi_kecelakaan_lalin_perkantoran)
                        ...
                        $("#kecelakaan_lalin_kawasan_wisata_p").html(dataPrev.lokasi_kecelakaan_lalin_wisata)
                        ...
                        $("#kecelakaan_lalin_kawasan_industri_p").html(dataPrev.lokasi_kecelakaan_lalin_industri)
                        ...
                        $("#kecelakaan_lalin_kawasan_lainlain_p").html(dataPrev.lokasi_kecelakaan_lalin_lain_lain)
                        ...
                        $("#kecelakaan_lalin_status_jalan_nasional_p").html(dataPrev.lokasi_kecelakaan_status_jalan_nasional)
                        ...
                        $("#kecelakaan_lalin_status_jalan_propinsi_p").html(dataPrev.lokasi_kecelakaan_status_jalan_propinsi)
                        ...
                        $("#kecelakaan_lalin_status_jalan_kabkota_p").html(dataPrev.lokasi_kecelakaan_status_jalan_kab_kota)
                        ...
                        $("#kecelakaan_lalin_status_jalan_desa_p").html(dataPrev.lokasi_kecelakaan_status_jalan_desa_lingkungan)
                        ...
                        $("#kecelakaan_lalin_status_jalan_arteri_p").html(dataPrev.lokasi_kecelakaan_fungsi_jalan_arteri)
                        ...
                        $("#kecelakaan_lalin_status_jalan_kolektor_p").html(dataPrev.lokasi_kecelakaan_fungsi_jalan_kolektor)
                        ...
                        $("#kecelakaan_lalin_status_jalan_lokal_p").html(dataPrev.lokasi_kecelakaan_fungsi_jalan_lokal)
                        ...
                        $("#kecelakaan_lalin_status_jalan_lingkungan_p").html(dataPrev.lokasi_kecelakaan_fungsi_jalan_lingkungan)
                        ...
                        $("#kecelakaan_lalin_penyebab_manusia_p").html(dataPrev.faktor_penyebab_kecelakaan_manusia)
                        ...
                        $("#kecelakaan_lalin_penyebab_ngantuk_p").html(dataPrev.faktor_penyebab_kecelakaan_ngantuk_lelah)
                        ...
                        $("#kecelakaan_lalin_penyebab_mabuk_p").html(dataPrev.faktor_penyebab_kecelakaan_mabuk_obat)
                        ...
                        $("#kecelakaan_lalin_penyebab_sakit_p").html(dataPrev.faktor_penyebab_kecelakaan_sakit)
                        ...
                        $("#kecelakaan_lalin_penyebab_hp_p").html(dataPrev.faktor_penyebab_kecelakaan_handphone_elektronik)
                        ...
                        $("#kecelakaan_lalin_penyebab_lampu_merah_p").html(dataPrev.faktor_penyebab_kecelakaan_menerobos_lampu_merah)
                        ...
                        $("#kecelakaan_lalin_penyebab_batas_cepat_p").html(dataPrev.faktor_penyebab_kecelakaan_melanggar_batas_kecepatan)
                        ...
                        $("#kecelakaan_lalin_penyebab_jaga_jarak_p").html(dataPrev.faktor_penyebab_kecelakaan_tidak_menjaga_jarak)
                        ...
                        $("#kecelakaan_lalin_penyebab_pindah_jalur_p").html(dataPrev.faktor_penyebab_kecelakaan_mendahului_berbelok_pindah_jalur)
                        ...
                        $("#kecelakaan_lalin_penyebab_pindah_lajur_p").html(dataPrev.faktor_penyebab_kecelakaan_berpindah_jalur)
                        ...
                        $("#kecelakaan_lalin_penyebab_lampu_isyarat_p").html(dataPrev.faktor_penyebab_kecelakaan_tidak_memberikan_lampu_isyarat)
                        ...
                        $("#kecelakaan_lalin_penyebab_pejalan_kaki_p").html(dataPrev.faktor_penyebab_kecelakaan_tidak_mengutamakan_pejalan_kaki)
                        ...
                        $("#kecelakaan_lalin_penyebab_lainnya_p").html(dataPrev.faktor_penyebab_kecelakaan_lainnya)
                        ...
                        $("#kecelakaan_lalin_penyebab_alam_p").html(dataPrev.faktor_penyebab_kecelakaan_alam)
                        ...
                        $("#kecelakaan_lalin_penyebab_kendaraan_p").html(dataPrev.faktor_penyebab_kecelakaan_kelaikan_kendaraan)
                        ...
                        $("#kecelakaan_lalin_penyebab_kondisi_jalan_p").html(dataPrev.faktor_penyebab_kecelakaan_kondisi_jalan)
                        ...
                        $("#kecelakaan_lalin_penyebab_prasarana_p").html(dataPrev.faktor_penyebab_kecelakaan_prasarana_jalan)
                        ...
                        $("#kecelakaan_lalin_penyebab_prasarana_rambu_p").html(dataPrev.faktor_penyebab_kecelakaan_rambu)
                        ...
                        $("#kecelakaan_lalin_penyebab_prasarana_makna_p").html(dataPrev.faktor_penyebab_kecelakaan_marka)
                        ...
                        $("#kecelakaan_lalin_penyebab_prasarana_apil_p").html(dataPrev.faktor_penyebab_kecelakaan_apil)
                        ...
                        $("#kecelakaan_lalin_penyebab_prasarana_palangpintu_p").html(dataPrev.faktor_penyebab_kecelakaan_perlintasan_ka_palang_pintu)
                        ...
                        $("#kecelakaan_lalin_waktu_0003_p").html(dataPrev.waktu_kejadian_kecelakaan_00_03)
                        ...
                        $("#kecelakaan_lalin_waktu_0306_p").html(dataPrev.waktu_kejadian_kecelakaan_03_06)
                        ...
                        $("#kecelakaan_lalin_waktu_0609_p").html(dataPrev.waktu_kejadian_kecelakaan_06_09)
                        ...
                        $("#kecelakaan_lalin_waktu_0912_p").html(dataPrev.waktu_kejadian_kecelakaan_09_12)
                        ...
                        $("#kecelakaan_lalin_waktu_1215_p").html(dataPrev.waktu_kejadian_kecelakaan_12_15)
                        ...
                        $("#kecelakaan_lalin_waktu_1518_p").html(dataPrev.waktu_kejadian_kecelakaan_15_18)
                        ...
                        $("#kecelakaan_lalin_waktu_1821_p").html(dataPrev.waktu_kejadian_kecelakaan_18_21)
                        ...
                        $("#kecelakaan_lalin_waktu_2124_p").html(dataPrev.waktu_kejadian_kecelakaan_21_24)
                        ...
                        $("#kecelakaan_lalin_menonjol_kejadian_p").html(dataPrev.kecelakaan_lalin_menonjol_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_menonjol_meninggal_p").html(dataPrev.kecelakaan_lalin_menonjol_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_menonjol_luka_berat_p").html(dataPrev.kecelakaan_lalin_menonjol_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_menonjol_luka_ringan_p").html(dataPrev.kecelakaan_lalin_menonjol_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_tunggal_kejadian_p").html(dataPrev.kecelakaan_lalin_tunggal_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_tunggal_meninggal_p").html(dataPrev.kecelakaan_lalin_tunggal_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_tunggal_luka_berat_p").html(dataPrev.kecelakaan_lalin_tunggal_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_tunggal_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tunggal_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_jalan_kaki_kejadian_p").html(dataPrev.kecelakaan_lalin_tabrak_pejalan_kaki_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_jalan_kaki_meninggal_p").html(dataPrev.kecelakaan_lalin_tabrak_pejalan_kaki_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_jalan_kaki_luka_berat_p").html(dataPrev.kecelakaan_lalin_tabrak_pejalan_kaki_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_jalan_kaki_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tabrak_pejalan_kaki_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_jalan_kaki_materiil_p").html(dataPrev.kecelakaan_lalin_tabrak_pejalan_kaki_materiil)
                        ...
                        $("#kecelakaan_lalin_tabrak_lari_kejadian_p").html(dataPrev.kecelakaan_lalin_tabrak_lari_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_tabrak_lari_meninggal_p").html(dataPrev.kecelakaan_lalin_tabrak_lari_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_tabrak_lari_luka_berat_p").html(dataPrev.kecelakaan_lalin_tabrak_lari_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_tabrak_lari_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tabrak_lari_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_tabrak_motor_kejadian_p").html(dataPrev.kecelakaan_lalin_tabrak_sepeda_motor_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_tabrak_motor_meninggal_p").html(dataPrev.kecelakaan_lalin_tabrak_sepeda_motor_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_tabrak_motor_luka_berat_p").html(dataPrev.kecelakaan_lalin_tabrak_sepeda_motor_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_tabrak_motor_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tabrak_sepeda_motor_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_tabrak_motor_materiil_p").html(dataPrev.kecelakaan_lalin_tabrak_sepeda_motor_materiil)
                        ...
                        $("#kecelakaan_lalin_tabrak_roda4_kejadian_p").html(dataPrev.kecelakaan_lalin_tabrak_roda_empat_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_tabrak_roda4_meninggal_p").html(dataPrev.kecelakaan_lalin_tabrak_roda_empat_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_tabrak_roda4_luka_berat_p").html(dataPrev.kecelakaan_lalin_tabrak_roda_empat_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_tabrak_roda4_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tabrak_roda_empat_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_tabrak_roda4_materiil_p").html(dataPrev.kecelakaan_lalin_tabrak_roda_empat_materiil)
                        ...
                        $("#kecelakaan_lalin_tidak_motor_kejadian_p").html(dataPrev.kecelakaan_lalin_tabrak_tidak_bermotor_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_tidak_motor_meninggal_p").html(dataPrev.kecelakaan_lalin_tabrak_tidak_bermotor_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_tidak_motor_luka_berat_p").html(dataPrev.kecelakaan_lalin_tabrak_tidak_bermotor_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_tidak_motor_luka_ringan_p").html(dataPrev.kecelakaan_lalin_tabrak_tidak_bermotor_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_tidak_motor_materiil_p").html(dataPrev.kecelakaan_lalin_tabrak_tidak_bermotor_materiil)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_kejadian_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_jumlah_kejadian)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_berpalang_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_berpalang_pintu)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_tidak_berpalang_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_tidak_berpalang_pintu)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_luka_ringan_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_korban_luka_ringan)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_luka_berat_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_korban_luka_berat)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_meninggal_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_korban_meninggal)
                        ...
                        $("#kecelakaan_lalin_pelintasan_ka_materiil_p").html(dataPrev.kecelakaan_lalin_perlintasan_ka_materiil)
                        ...
                        $("#kecelakaan_lalin_transportasi_ka_p").html(dataPrev.kecelakaan_transportasi_kereta_api)
                        ...
                        $("#kecelakaan_lalin_transportasi_laut_p").html(dataPrev.kecelakaan_transportasi_laut_perairan)
                        ...
                        $("#kecelakaan_lalin_transportasi_udara_p").html(dataPrev.kecelakaan_transportasi_udara)
                        ...
                        $("#dikmas_lantas_penluh_cetak_p").html(dataPrev.penlu_melalui_media_cetak)
                        ...
                        $("#dikmas_lantas_penluh_elektronik_p").html(dataPrev.penlu_melalui_media_elektronik)
                        ...
                        $("#dikmas_lantas_penluh_keramaian_p").html(dataPrev.penlu_melalui_tempat_keramaian)
                        ...
                        $("#dikmas_lantas_penluh_istirahat_p").html(dataPrev.penlu_melalui_tempat_istirahat)
                        ...
                        $("#dikmas_lantas_penluh_langgar_p").html(dataPrev.penlu_melalui_daerah_rawan_laka_dan_langgar)
                        ...
                        $("#dikmas_lantas_penluh_spanduk_p").html(dataPrev.penyebaran_pemasangan_spanduk)
                        ...
                        $("#dikmas_lantas_penluh_leaflet_p").html(dataPrev.penyebaran_pemasangan_leaflet)
                        ...
                        $("#dikmas_lantas_penluh_sticker_p").html(dataPrev.penyebaran_pemasangan_sticker)
                        ...
                        $("#dikmas_lantas_penluh_bilboard_p").html(dataPrev.penyebaran_pemasangan_bilboard)
                        ...
                        $("#dikmas_lantas_penluh_polisi_anak_p").html(dataPrev.polisi_sahabat_anak)
                        ...
                        $("#dikmas_lantas_penluh_cara_aman_p").html(dataPrev.cara_aman_sekolah)
                        ...
                        $("#dikmas_lantas_penluh_patroli_p").html(dataPrev.patroli_keamanan_sekolah)
                        ...
                        $("#dikmas_lantas_penluh_pramuka_p").html(dataPrev.pramuka_bhayangkara_krida_lalu_lintas)
                        ...
                        $("#dikmas_lantas_penluh_police_campus_p").html(dataPrev.police_goes_to_campus)
                        ...
                        $("#dikmas_lantas_penluh_safety_riding_p").html(dataPrev.safety_riding_driving)
                        ...
                        $("#dikmas_lantas_forum_lalin_p").html(dataPrev.forum_lalu_lintas_angkutan_umum)
                        ...
                        $("#dikmas_lantas_penluh_kampanye_p").html(dataPrev.kampanye_keselamatan)
                        ...
                        $("#dikmas_lantas_penluh_mengemudi_p").html(dataPrev.sekolah_mengemudi)
                        ...
                        $("#dikmas_lantas_penluh_taman_lalin_p").html(dataPrev.taman_lalu_lintas)
                        ...
                        $("#dikmas_lantas_penluh_global_road_p").html(dataPrev.global_road_safety_partnership_action)
                        ...
                        $("#dikmas_lantas_giatlantas_pengaturan_p").html(dataPrev.giat_lantas_pengaturan)
                        ...
                        $("#dikmas_lantas_giatlantas_penjagaan_p").html(dataPrev.giat_lantas_penjagaan)
                        ...
                        $("#dikmas_lantas_giatlantas_pengawalan_p").html(dataPrev.giat_lantas_pengawalan)
                        ...
                        $("#dikmas_lantas_giatlantas_patroli_p").html(dataPrev.giat_lantas_patroli)
