...
<div class="page-title">
    <h3>
        ...
        <span>REKAPITULASI LAPORAN ANEV PERBANDINGAN HARI OPERASI</span>
    </h3>
</div>
@endpush
@section('content')
...
<script>
    ...
    $("#operation_id").on("change", function (e) {
        ...
        if($(this).val()) {
            ...
            .then(function (response) {
                ...
                $('#tanggal_pembanding_1').datepicker('setStartDate', minDate)
                $('#tanggal_pembanding_1').datepicker('setEndDate', maxDate)

                $('#tanggal_pembanding_2').datepicker('setStartDate', minDate)
                $('#tanggal_pembanding_2').datepicker('setEndDate', maxDate)
            })
    ...
    $("#tanggal_pembanding_2").on("change", function (e) {
        ...
        if($(this).val()) {
            ...
            popupCenter({
                url: route('show_anev_daily_excel_to_view', {
                    operation_id: $("#operation_id").val(),
                    tanggal_pembanding_pertama: $("#tanggal_pembanding_1").val(),
                    tanggal_pembanding_kedua: $(this).val(),
                }),
                title: 'Detail',
                w: 1000, h: 600
            })
