                ...
                <div class="widget-content text-artikel mt-1">
                    <form method="POST" action="{{ route('polda_store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control artikel @error('name') is-invalid @enderror" id="name" name="name" autocomplete="off" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control artikel @error('short_name') is-invalid @enderror" id="short_name" name="short_name" autocomplete="off" value="{{ old('short_name') }}">
                            @error('short_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
