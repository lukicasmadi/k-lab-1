        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 mb-25 layout-spacing">
            <div class="widget-content">
                <div class="col-md-12 text-left mb-3">
                    <div class="text-left">
                        <div class="row">
                            <a id="btnShowModal" class="btn add-operasi" href="{{ route('violation_create') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path id="add_to_queue" d="M16,22H4a2,2,0,0,1-2-2V8H4V20H16Zm4-4H8a2,2,0,0,1-2-2V4A2,2,0,0,1,8,2H20a2,2,0,0,1,2,2V16A2,2,0,0,1,20,18ZM8,4V16H20V4Zm7,10H13V11H10V9h3V6h2V9h3v2H15Z" transform="translate(-2 -2)" fill="#fff"/></svg>
                            TAMBAH POLDA
                            </a>
                        </div>
                    </div>
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    <div class="ubah-change">
                        <a href="`+route('violation_edit', data)+`">Ubah</a> <span>|</span> <a href="`+route('violation_destroy', data)+`" class="delete" data-id="`+data+`">Hapus</a>
                    </div>
                    `;
                },
                searchable: false,
