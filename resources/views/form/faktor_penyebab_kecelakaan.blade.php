    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('faktor_penyebab_kecelakaan_hanphone_eletronik') is-invalid @enderror" name="faktor_penyebab_kecelakaan_hanphone_eletronik" autocomplete="off" value="{{ old('faktor_penyebab_kecelakaan_hanphone_eletronik') }}">
                @error('faktor_penyebab_kecelakaan_hanphone_eletronik')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
