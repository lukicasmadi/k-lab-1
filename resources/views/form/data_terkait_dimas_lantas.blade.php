    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('polisi_sahabat_anak') is-invalid @enderror" name="polisi_sahabat_anak" autocomplete="off" value="{{ old('polisi_sahabat_anak') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('cara_aman_sekolah') is-invalid @enderror" name="cara_aman_sekolah" autocomplete="off" value="{{ old('cara_aman_sekolah') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('patroli_keamanan_sekolah') is-invalid @enderror" name="patroli_keamanan_sekolah" autocomplete="off" value="{{ old('patroli_keamanan_sekolah') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('pramuka_bhayangkara_krida_lalu_lintas') is-invalid @enderror" name="pramuka_bhayangkara_krida_lalu_lintas" autocomplete="off" value="{{ old('pramuka_bhayangkara_krida_lalu_lintas') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('police_goes_to_campus') is-invalid @enderror" name="police_goes_to_campus" autocomplete="off" value="{{ old('police_goes_to_campus') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('safety_riding_driving') is-invalid @enderror" name="safety_riding_driving" autocomplete="off" value="{{ old('safety_riding_driving') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('forum_lalu_lintas_angkutan_umum') is-invalid @enderror" name="forum_lalu_lintas_angkutan_umum" autocomplete="off" value="{{ old('forum_lalu_lintas_angkutan_umum') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('kampanye_keselamatan') is-invalid @enderror" name="kampanye_keselamatan" autocomplete="off" value="{{ old('kampanye_keselamatan') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('sekolah_mengemudi') is-invalid @enderror" name="sekolah_mengemudi" autocomplete="off" value="{{ old('sekolah_mengemudi') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('taman_lalu_lintas') is-invalid @enderror" name="taman_lalu_lintas" autocomplete="off" value="{{ old('taman_lalu_lintas') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('global_road_safety_partnership_action') is-invalid @enderror" name="global_road_safety_partnership_action" autocomplete="off" value="{{ old('global_road_safety_partnership_action') }}">
