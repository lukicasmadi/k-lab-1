                    ...
                    <div class="card-body">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_sepeda_motor') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_sepeda_motor" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_sepeda_motor') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_mobil_penumpang') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_mobil_penumpang" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_mobil_penumpang') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_mobil_bus') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_mobil_bus" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_mobil_bus') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_mobil_barang') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_mobil_barang" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_mobil_barang') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_kendaraan_khusus') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_kendaraan_khusus" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_kendaraan_khusus') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yg_terlibat_kecelakaan_kendaraan_tidak_bermotor') is-invalid @enderror" name="kendaraan_yg_terlibat_kecelakaan_kendaraan_tidak_bermotor" autocomplete="off" value="{{ old('kendaraan_yg_terlibat_kecelakaan_kendaraan_tidak_bermotor') }}">
