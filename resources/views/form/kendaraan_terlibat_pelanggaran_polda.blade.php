                    ...
                    <div class="card-body">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yang_terlibat_pelanggaran_sepeda_motor_prev') is-invalid @enderror" name="kendaraan_yang_terlibat_pelanggaran_sepeda_motor_prev" autocomplete="off" value="{{ old('kendaraan_yang_terlibat_pelanggaran_sepeda_motor_prev') }}">
                                    @error('kendaraan_yang_terlibat_pelanggaran_sepeda_motor_prev')
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yang_terlibat_pelanggaran_mobil_penumpang_prev') is-invalid @enderror" name="kendaraan_yang_terlibat_pelanggaran_mobil_penumpang_prev" autocomplete="off" value="{{ old('kendaraan_yang_terlibat_pelanggaran_mobil_penumpang_prev') }}">
                                    @error('kendaraan_yang_terlibat_pelanggaran_mobil_penumpang_prev')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yang_terlibat_pelanggaran_mobil_bus_prev') is-invalid @enderror" name="kendaraan_yang_terlibat_pelanggaran_mobil_bus_prev" autocomplete="off" value="{{ old('kendaraan_yang_terlibat_pelanggaran_mobil_bus_prev') }}">
                                    @error('kendaraan_yang_terlibat_pelanggaran_mobil_bus_prev')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kendaraan_yang_terlibat_pelanggaran_mobil_barang_prev') is-invalid @enderror" name="kendaraan_yang_terlibat_pelanggaran_mobil_barang_prev" autocomplete="off" value="{{ old('kendaraan_yang_terlibat_pelanggaran_mobil_barang_prev') }}">
                                    @error('kendaraan_yang_terlibat_pelanggaran_mobil_barang_prev')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
