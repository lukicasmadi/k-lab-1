                    ...
                    <div class="card-body">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_lalin_menonjol_jumlah_kejadian_p') is-invalid @enderror" name="kecelakaan_lalin_menonjol_jumlah_kejadian_p" autocomplete="off" value="{{ old('kecelakaan_lalin_menonjol_jumlah_kejadian_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_lalin_menonjol_korban_meninggal_p') is-invalid @enderror" name="kecelakaan_lalin_menonjol_korban_meninggal_p" autocomplete="off" value="{{ old('kecelakaan_lalin_menonjol_korban_meninggal_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_lalin_menonjol_korban_luka_berat_p') is-invalid @enderror" name="kecelakaan_lalin_menonjol_korban_luka_berat_p" autocomplete="off" value="{{ old('kecelakaan_lalin_menonjol_korban_luka_berat_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_lalin_menonjol_korban_luka_ringan_p') is-invalid @enderror" name="kecelakaan_lalin_menonjol_korban_luka_ringan_p" autocomplete="off" value="{{ old('kecelakaan_lalin_menonjol_korban_luka_ringan_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_lalin_menonjol_materiil_p') is-invalid @enderror" name="kecelakaan_lalin_menonjol_materiil_p" autocomplete="off" value="{{ old('kecelakaan_lalin_menonjol_materiil_p') }}">
