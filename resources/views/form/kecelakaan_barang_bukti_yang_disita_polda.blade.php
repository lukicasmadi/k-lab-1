                    ...
                    <div class="card-body">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_barang_bukti_yg_disita_sim_prev') is-invalid @enderror" name="kecelakaan_barang_bukti_yg_disita_sim_prev" autocomplete="off" value="{{ old('kecelakaan_barang_bukti_yg_disita_sim_prev') }}">
                                    @error('kecelakaan_barang_bukti_yg_disita_sim_prev')
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_barang_bukti_yg_disita_stnk_prev') is-invalid @enderror" name="kecelakaan_barang_bukti_yg_disita_stnk_prev" autocomplete="off" value="{{ old('kecelakaan_barang_bukti_yg_disita_stnk_prev') }}">
                                    @error('kecelakaan_barang_bukti_yg_disita_stnk_prev')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('kecelakaan_barang_bukti_yg_disita_kendaraan_prev') is-invalid @enderror" name="kecelakaan_barang_bukti_yg_disita_kendaraan_prev" autocomplete="off" value="{{ old('kecelakaan_barang_bukti_yg_disita_kendaraan_prev') }}">
                                    @error('kecelakaan_barang_bukti_yg_disita_kendaraan_prev')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
