    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('usia_pelaku_pelanggaran_66_60_tahun') is-invalid @enderror" name="usia_pelaku_pelanggaran_66_60_tahun" autocomplete="off" value="{{ old('usia_pelaku_pelanggaran_66_60_tahun') }}">
