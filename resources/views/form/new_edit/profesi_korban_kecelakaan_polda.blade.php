                    ...
                    <div class="card-body">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_pns_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_pns_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_pns_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_karwayan_swasta_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_karwayan_swasta_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_karwayan_swasta_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_pelajar_mahasiswa_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_pelajar_mahasiswa_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_pelajar_mahasiswa_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_pengemudi_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_pengemudi_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_pengemudi_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_tni_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_tni_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_tni_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_polri_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_polri_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_polri_p') }}">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 line-onsite">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-12 col-sm-12 col-12">
                                    <input type="number" class="form-onsite @error('profesi_korban_kecelakaan_lalin_lain_lain_p') is-invalid @enderror" name="profesi_korban_kecelakaan_lalin_lain_lain_p" autocomplete="off" value="{{ old('profesi_korban_kecelakaan_lalin_lain_lain_p') }}">
