<div class="modal fade" id="modalReportAllPoldaByOperation" tabindex="-1" role="dialog" aria-labelledby="modalReportAllPoldaByOperation" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ route('all_polda_by_operation') }}">
                @csrf
                        ...
                        <div class="notes-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control form-custom height-form" id="poldaList" name="poldaList">
                ...
                <div class="modal-footer">
                    <input type="submit" name="submit" class="btn" value="LIHAT" id="btn-n-add">
                </div>
            </form>
        </div>
    </div>
