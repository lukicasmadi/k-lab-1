(function (e, t) {
 ...
 function e(e) {
     ...
     return (t.prototype = s(Object.create(e.prototype), { constructor: t })), "function" == typeof Object.setPrototypeOf ? Object.setPrototypeOf(t, e) : (t.__proto__ = e), t;
 }
 function t() {
     var e = Ae.innerParams.get(this),
         t = Ae.domCache.get(this);
     e.showConfirmButton || (V(t.confirmButton), !e.showCancelButton && V(t.actions)),
 ...
 function n(e) {
     ...
     if (
         ...
         e.html ? oe(e.html, d) : e.text ? ((d.textContent = e.text), T(d)) : V(d),
         e.position in k ? L(i, k[e.position]) : (f('The "position" parameter is not valid, defaulting to "center"'), L(i, k.center)),
     ...
     "function" == typeof e.animation && (e.animation = e.animation.call()),
         e.showCloseButton ? (g.setAttribute("aria-label", e.closeButtonAriaLabel), T(g)) : V(g),
         (t.className = k.popup),
         e.toast ? (L([document.documentElement, document.body], k["toast-shown"]), L(t, k.toast)) : L(t, k.modal),
 ...
 var a =
     ...
     C = Object.freeze({ cancel: "cancel", backdrop: "overlay", close: "close", esc: "esc", timer: "timer" }),
     x = function (e) {
         var t = {};
     ...
     re = function () {
         null !== A.previousBodyPadding ||
             (document.body.scrollHeight > window.innerHeight &&
                 ((A.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))), (document.body.style.paddingRight = A.previousBodyPadding + ae() + "px")));
     },
     se = function () {
     ...
     pe = function (e, t) {
         ...
         if (o) {
             ...
             var i = function () {
                 $() || (ce(), window.removeEventListener("keydown", ue.keydownHandler, { capture: !0 }), (ue.keydownHandlerAdded = !1)),
             ...
             ie && !E(o, k.noanimation)
                 ? o.addEventListener(ie, function e() {
 ...
 var Ae = { promise: new WeakMap(), innerParams: new WeakMap(), domCache: new WeakMap() },
     Ee = {
         email: function (e, t) {
     ...
     Se = function (e) {
         ...
         null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n),
             e.animation ? (L(n, k.show), L(t, k.fade), _(n, k.hide)) : _(n, k.fade),
             T(n),
             (t.style.overflowY = "hidden"),
             ie && !E(n, k.noanimation)
                 ? n.addEventListener(ie, function e() {
     ...
     Pe = Object.freeze({
         ...
         getInput: function (e) {
             ...
             return ((e = e || t.input), !e)
                 ...
                 : "radio" === e
                 ? n.popup.querySelector("." + k.radio + " input:checked") || n.popup.querySelector("." + k.radio + " input:first-child")
                 : "range" === e
         ...
         _main: function (e) {
             ...
             var r = { popup: R(), container: M(), content: W(), actions: Q(), confirmButton: F(), cancelButton: Y(), closeButton: X(), validationError: z(), progressSteps: K() };
             Ae.domCache.set(this, r);
             var l = this.constructor;
             return new Promise(function (e, n) {
                 var s = function (t) {
                         l.closePopup(o.onClose, o.onAfterClose), o.useRejections ? e(t) : e({ value: t });
                     },
                     d = function (t) {
                         l.closePopup(o.onClose, o.onAfterClose), o.useRejections ? n(t) : e({ dismiss: t });
                     },
                     u = function (e) {
                         l.closePopup(o.onClose, o.onAfterClose), n(e);
                     };
                 o.timer &&
                     (ue.timeout = setTimeout(function () {
                         return d("timer");
                     }, o.timer));
                 var p = function () {
                     var e = t.getInput();
                 ...
                 for (
                     var g = function (e) {
                         ...
                         f = function (n) {
                             ...
                             switch (i.type) {
                                 case "click":
                                     if (!(c && l.isVisible())) m && l.isVisible() && (t.disableButtons(), d(l.DismissReason.cancel));
                     ...
                     (b[y].onclick = f), (b[y].onmouseover = f), (b[y].onmouseout = f), (b[y].onmousedown = f);
                 if (
                     ...
                     x = function (n, e) {
                         ...
                         if ("Enter" === n.key && !n.isComposing) {
                             ...
                             -1 === ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(n.key)
                                 ? ("Escape" === n.key || "Esc" === n.key) && !0 === v(e.allowEscapeKey) && d(l.DismissReason.esc)
                                 : document.activeElement === r.confirmButton && H(r.cancelButton)
                                 ? r.cancelButton.focus()
                                 : document.activeElement === r.cancelButton && H(r.confirmButton) && r.confirmButton.focus();
                     };
                 ue.keydownHandlerAdded && (window.removeEventListener("keydown", ue.keydownHandler, { capture: !0 }), (ue.keydownHandlerAdded = !1)),
                     o.toast ||
                         ((ue.keydownHandler = function (t) {
                             return x(t, o);
                         }),
                         window.addEventListener("keydown", ue.keydownHandler, { capture: !0 }),
                 ...
                 if ("select" === o.input || "radio" === o.input) {
                     ...
                     w(o.inputOptions)
                         ...
                         ? J(o.inputOptions)
                         : h("Unexpected type of inputOptions! Expected object, Map or Promise, got " + a(o.inputOptions));
                 } else
                     -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(o.input) &&
                         w(o.inputValue) &&
                         (l.showLoading(),
                         V(A),
                         o.inputValue
                 ...
                 Se(o),
                     o.toast ||
                         (v(o.allowEnterKey)
                             ? o.focusCancel && H(r.cancelButton)
                                 ? r.cancelButton.focus()
                                 : o.focusConfirm && H(r.confirmButton)
